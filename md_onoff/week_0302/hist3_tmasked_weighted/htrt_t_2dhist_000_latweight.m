...
t_ed_series_thresh = reshape(t_ed_ll_000,[numel(t_ed_ll_000),1]);
[t_dist,t_val] = hist(t_ed_series_thresh,100);
t_sum = cumsum(t_dist)./sum(t_dist);
t_thresh_000_pos = t_val(min(find(t_sum>=0.95)));
t_thresh_000_neg = t_val(max(find(t_sum<=0.05)));
...
t_mask_000 = +(t_ed_series_000 > t_thresh_000_pos | t_ed_series_000 < t_thresh_000_neg);

t_ed_series_000_masked = t_mask_000.*t_ed_series_000; 
t_ed_series_000_masked(t_mask_000==0) = [];
htrt_ed_series_000_masked = t_mask_000.*htrt_ed_series_000; 
htrt_ed_series_000_masked(t_mask_000==0) = [];
cnvht_ed_series_000_masked = t_mask_000.*cnvht_ed_series_000; 
cnvht_ed_series_000_masked(t_mask_000==0) = [];
cndht_ed_series_000_masked = t_mask_000.*cndht_ed_series_000; 
cndht_ed_series_000_masked(t_mask_000==0) = [];
difht_ed_series_000_masked = t_mask_000.*difht_ed_series_000; 
difht_ed_series_000_masked(t_mask_000==0) = [];
radht_ed_series_000_masked = t_mask_000.*radht_ed_series_000; 
radht_ed_series_000_masked(t_mask_000==0) = [];
