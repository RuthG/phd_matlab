...
t_ed_series_thresh = reshape(t_ed_ll_100,[numel(t_ed_ll_100),1]);
[t_dist,t_val] = hist(t_ed_series_thresh,100);
t_sum = cumsum(t_dist)./sum(t_dist);
t_thresh_100_pos = t_val(min(find(t_sum>=0.95)));
t_thresh_100_neg = t_val(max(find(t_sum<=0.05)));
...
t_mask_100 = +(t_ed_series_100 > t_thresh_100_pos | t_ed_series_100 < t_thresh_100_neg);

t_ed_series_100_masked = t_mask_100.*t_ed_series_100; 
t_ed_series_100_masked(t_mask_100==0) = [];
htrt_ed_series_100_masked = t_mask_100.*htrt_ed_series_100; 
htrt_ed_series_100_masked(t_mask_100==0) = [];
cnvht_ed_series_100_masked = t_mask_100.*cnvht_ed_series_100; 
cnvht_ed_series_100_masked(t_mask_100==0) = [];
cndht_ed_series_100_masked = t_mask_100.*cndht_ed_series_100; 
cndht_ed_series_100_masked(t_mask_100==0) = [];
difht_ed_series_100_masked = t_mask_100.*difht_ed_series_100; 
difht_ed_series_100_masked(t_mask_100==0) = [];
radht_ed_series_100_masked = t_mask_100.*radht_ed_series_100; 
radht_ed_series_100_masked(t_mask_100==0) = [];
