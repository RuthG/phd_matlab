...
t_ed_series_thresh = reshape(t_ed_ll_050,[numel(t_ed_ll_050),1]);
[t_dist,t_val] = hist(t_ed_series_thresh,100);
t_sum = cumsum(t_dist)./sum(t_dist);
t_thresh_050_pos = t_val(min(find(t_sum>=0.95)));
t_thresh_050_neg = t_val(max(find(t_sum<=0.05)));
...
t_mask_050 = +(t_ed_series_050 > t_thresh_050_pos | t_ed_series_050 < t_thresh_050_neg);

t_ed_series_050_masked = t_mask_050.*t_ed_series_050; 
t_ed_series_050_masked(t_mask_050==0) = [];
htrt_ed_series_050_masked = t_mask_050.*htrt_ed_series_050; 
htrt_ed_series_050_masked(t_mask_050==0) = [];
cnvht_ed_series_050_masked = t_mask_050.*cnvht_ed_series_050; 
cnvht_ed_series_050_masked(t_mask_050==0) = [];
cndht_ed_series_050_masked = t_mask_050.*cndht_ed_series_050; 
cndht_ed_series_050_masked(t_mask_050==0) = [];
difht_ed_series_050_masked = t_mask_050.*difht_ed_series_050; 
difht_ed_series_050_masked(t_mask_050==0) = [];
radht_ed_series_050_masked = t_mask_050.*radht_ed_series_050; 
radht_ed_series_050_masked(t_mask_050==0) = [];
