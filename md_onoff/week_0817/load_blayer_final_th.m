...
for j=1:10
i=0
zpbl_th = zeros(192,32,360);
rich_th = zeros(192,32,25,360);
...
name=['/project/rg312/mat_files/snapshot_data_final/run_th/rich_th_' num2str(j) '.mat'];
save(name,'rich_th')

name=['/project/rg312/mat_files/snapshot_data_final/run_th/zpbl_th_' num2str(j) '.mat'];
save(name,'zpbl_th')
