...
function [dcoeff_p, dcoeff_n, jth_ed_p, jth_ed_n, th_var_p, th_var_n] = damping_coeff_trop_fun(run, var)
...
dcoeff_ll_n_pav = squeeze(mean(dcoeff_ll_n(:,blev(xn)+1:tlev(xn),:),2));
dcoeff_ll_p_pav = squeeze(mean(dcoeff_ll_p(:,blev(xn)+1:tlev(xn),:),2));
jth_ll_n_pav = squeeze(mean(jth_ll_n(:,blev(xn)+1:tlev(xn),:),2));
jth_ll_p_pav = squeeze(mean(jth_ll_p(:,blev(xn)+1:tlev(xn),:),2));
thth_ll_n_pav = squeeze(mean(thth_ll_n(:,blev(xn)+1:tlev(xn),:),2));
thth_ll_p_pav = squeeze(mean(thth_ll_p(:,blev(xn)+1:tlev(xn),:),2));
