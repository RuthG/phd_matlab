...
load(['/project/rg312/mat_files/snapshot_data_final/run_025/vN_025_' num2str(modelyear) '.mat'])
vNll=cube2latlon(xc,yc,vN_025,xi,yi);

for i=1:90
integrand(:,i,:,:) = vNll(:,i,:,:).*rad.*cos(yi(i)*dtr)./g.*4000.*deltalam;
end

load(['/project/rg312/mat_files/snapshot_data_final/run_025/theta_025_' num2str(modelyear) '.mat'])
thetall=cube2latlon(xc,yc,theta_025,xi,yi);
...
save('/project/rg312/mat_files/chapter2_variables/psi_theta_025.mat','psi_mean')