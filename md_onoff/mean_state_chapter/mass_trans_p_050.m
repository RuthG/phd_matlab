...
load(['/project/rg312/mat_files/snapshot_data_final/run_050/vN_050_' num2str(j) '.mat'])
...
'Take time average'
psi_050(:,:,j) = mean(integral_lam,3);

end

psi_050 = mean(psi_050,3);

for i=1:45
psi_050_hzav(46-i,:) = (-1*psi_050(i,:) + psi_050(91-i,:))./2;
end

save('/project/rg312/mat_files/chapter2_variables/psi_tav_050.mat','psi_050','psi_050_hzav')
