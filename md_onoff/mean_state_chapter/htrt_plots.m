...
freezeColors
text(0.35,1.25,'Total diabatic heating rate, K/day','Units','normalized','FontSize',12)
...
title('010','FontSize',12)
freezeColors
text(0.35,1.25,'Convective heating rate, K/day','Units','normalized','FontSize',12)
