...
load('/project/rg312/mat_files/chapter2_variables/mom_budg_terms_000.mat')
contourf(yi(46:90),rC./1000,zeta3v_ed_hzav'+zeta2w_ed_hzav')
hold on
...
load('/project/rg312/mat_files/chapter2_variables/mom_budg_terms_010.mat')
contourf(yi(46:90),rC./1000,zeta3v_ed_hzav'+zeta2w_ed_hzav')
hold on
...
load('/project/rg312/mat_files/chapter2_variables/mom_budg_terms_025.mat')
contourf(yi(46:90),rC./1000,zeta3v_ed_hzav'+zeta2w_ed_hzav')
hold on
...
load('/project/rg312/mat_files/chapter2_variables/mom_budg_terms_050.mat')
contourf(yi(46:90),rC./1000,zeta3v_ed_hzav'+zeta2w_ed_hzav')
hold on
...
load('/project/rg312/mat_files/chapter2_variables/mom_budg_terms_075.mat')
contourf(yi(46:90),rC./1000,zeta3v_ed_hzav'+zeta2w_ed_hzav')
hold on
...
load('/project/rg312/mat_files/chapter2_variables/mom_budg_terms_125.mat')
contourf(yi(46:90),rC./1000,zeta3v_ed_hzav'+zeta2w_ed_hzav')
hold on
...
load('/project/rg312/mat_files/chapter2_variables/mom_budg_terms_150.mat')
contourf(yi(46:90),rC./1000,zeta3v_ed_hzav'+zeta2w_ed_hzav')
hold on
