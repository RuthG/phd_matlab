...
load(['/project/rg312/mat_files/snapshot_data_final/run_150/vN_150_' num2str(modelyear) '.mat'])
vNll=cube2latlon(xc,yc,vN_150,xi,yi);

for i=1:90
integrand(:,i,:,:) = vNll(:,i,:,:).*rad.*cos(yi(i)*dtr)./g.*4000.*deltalam;
end

load(['/project/rg312/mat_files/snapshot_data_final/run_150/theta_150_' num2str(modelyear) '.mat'])
thetall=cube2latlon(xc,yc,theta_150,xi,yi);
...
save('/project/rg312/mat_files/chapter2_variables/psi_theta_150.mat','psi_mean')