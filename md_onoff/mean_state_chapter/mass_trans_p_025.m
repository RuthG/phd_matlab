...
load(['/project/rg312/mat_files/snapshot_data_final/run_025/vN_025_' num2str(j) '.mat'])
...
'Take time average'
psi_025(:,:,j) = mean(integral_lam,3);

end

psi_025 = mean(psi_025,3);

for i=1:45
psi_025_hzav(46-i,:) = (-1*psi_025(i,:) + psi_025(91-i,:))./2;
end

save('/project/rg312/mat_files/chapter2_variables/psi_tav_025.mat','psi_025','psi_025_hzav')
