...
load(['/project/rg312/mat_files/snapshot_data_final/run_010/vN_010_' num2str(j) '.mat'])
...
'Take time average'
psi_010(:,:,j) = mean(integral_lam,3);

end

psi_010 = mean(psi_010,3);

for i=1:45
psi_010_hzav(46-i,:) = (-1*psi_010(i,:) + psi_010(91-i,:))./2;
end

save('/project/rg312/mat_files/chapter2_variables/psi_tav_010.mat','psi_010','psi_010_hzav')
