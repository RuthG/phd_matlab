...
load(['/project/rg312/mat_files/snapshot_data_final/run_150/vN_150_' num2str(j) '.mat'])
...
'Take time average'
psi_150(:,:,j) = mean(integral_lam,3);

end

psi_150 = mean(psi_150,3);

for i=1:45
psi_150_hzav(46-i,:) = (-1*psi_150(i,:) + psi_150(91-i,:))./2;
end

save('/project/rg312/mat_files/chapter2_variables/psi_tav_150.mat','psi_150','psi_150_hzav')
