...
load(['/project/rg312/mat_files/snapshot_data_final/run_075/vN_075_' num2str(j) '.mat'])
...
'Take time average'
psi_075(:,:,j) = mean(integral_lam,3);

end

psi_075 = mean(psi_075,3);

for i=1:45
psi_075_hzav(46-i,:) = (-1*psi_075(i,:) + psi_075(91-i,:))./2;
end

save('/project/rg312/mat_files/chapter2_variables/psi_tav_075.mat','psi_075','psi_075_hzav')
