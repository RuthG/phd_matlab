...
load(['/project/rg312/mat_files/snapshot_data_final/run_075/vN_075_' num2str(modelyear) '.mat'])
vNll=cube2latlon(xc,yc,vN_075,xi,yi);

for i=1:90
integrand(:,i,:,:) = vNll(:,i,:,:).*rad.*cos(yi(i)*dtr)./g.*4000.*deltalam;
end

load(['/project/rg312/mat_files/snapshot_data_final/run_075/theta_075_' num2str(modelyear) '.mat'])
thetall=cube2latlon(xc,yc,theta_075,xi,yi);
...
save('/project/rg312/mat_files/chapter2_variables/psi_theta_075.mat','psi_mean')