...
load(['/project/rg312/mat_files/snapshot_data_final/run_000_ns/vN_000_' num2str(modelyear) '.mat'])
...
load(['/project/rg312/mat_files/snapshot_data_final/run_000_ns/theta_000_' num2str(modelyear) '.mat'])
...
save('/project/rg312/mat_files/chapter2_variables/psi_theta_000.mat','psi_mean')