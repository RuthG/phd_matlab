...
load(['/project/rg312/mat_files/snapshot_data_final/run_100/vN_100_' num2str(j) '.mat'])
...
'Take time average'
psi_100(:,:,j) = mean(integral_lam,3);

end

psi_100 = mean(psi_100,3);

for i=1:45
psi_100_hzav(46-i,:) = (-1*psi_100(i,:) + psi_100(91-i,:))./2;
end

save('/project/rg312/mat_files/chapter2_variables/psi_tav_100.mat','psi_100','psi_100_hzav')
