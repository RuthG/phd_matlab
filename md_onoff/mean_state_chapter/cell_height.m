...
radeq_press_000 = rC(min(find(t_hzav_000(1,:) - t_eq_000(1,:) <= 0)));
emheight_000 = ph_ll_zav_000(46,min(find(t_hzav_000(1,:) - t_eq_000(1,:) <= 0)))./9.8;
...
emheight_010 = ph_ll_zav_010(46,min(find(t_hzav_010(1,:) - t_eq_010(1,:) <= 0)))./9.8;
...
emheight_025 = ph_ll_zav_025(46,min(find(t_hzav_025(1,:) - t_eq_025(1,:) <= 0)))./9.8;
...
emheight_050 = ph_ll_zav_050(46,min(find(t_hzav_050(1,:) - t_eq_050(1,:) <= 0)))./9.8;
...
emheight_075 = ph_ll_zav_075(46,min(find(t_hzav_075(1,:) - t_eq_075(1,:) <= 0)))./9.8;
...
emheight_100 = ph_ll_zav_100(46,min(find(t_hzav_100(1,:) - t_eq_100(1,:) <= 0)))./9.8;
...
emheight_125 = ph_ll_zav_125(46,min(find(t_hzav_125(1,:) - t_eq_125(1,:) <= 0)))./9.8;
...
emheight_150 = ph_ll_zav_150(46,min(find(t_hzav_150(1,:) - t_eq_150(1,:) <= 0)))./9.8;
lapseav_150 = mean(dtdz_150(1,1:17),2);
height_est_150 = (1-alph).*surfT./lapseav_150.*1000 + alph.*emheight_150;

save('/project/rg312/mat_files/chapter2_variables/cell_height_est.mat', 'height_est_000', 'height_est_010', 'height_est_025', 'height_est_050', 'height_est_075', 'height_est_100', 'height_est_125', 'height_est_150')
