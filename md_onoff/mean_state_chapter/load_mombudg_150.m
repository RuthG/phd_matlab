...
uz_tav(:,:,:,j) = mean(uz_tava,4);
vz_tav(:,:,:,j) = mean(vz_tava,4);
ur_tav(:,:,:,j) = mean(ur_tava,4);
vr_tav(:,:,:,j) = mean(vr_tava,4);
uadv_tav(:,:,:,j) = mean(uadv_tava,4);
vadv_tav(:,:,:,j) = mean(vadv_tava,4);
uext_tav(:,:,:,j) = mean(uext_tava,4);
vext_tav(:,:,:,j) = mean(vext_tava,4);
vort3_tav(:,:,:,j) = mean(vort3_tava,4);
taux_tav(:,:,j) = mean(taux_tava,3);
tauy_tav(:,:,j) = mean(tauy_tava,3);
...
save('/project/rg312/mat_files/chapter2_variables/mombudg_tav_150.mat','uzE','vzN', 'urE','vrN','uadvE', 'vadvN', 'uextE', 'vextN', 'tauE', 'tauN', 'vort3_tav')