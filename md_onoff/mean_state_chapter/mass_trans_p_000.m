...
load(['/project/rg312/mat_files/snapshot_data_final/run_000_ns/vN_000_' num2str(j) '.mat'])
...
'Take time average'
psi_000(:,:,j) = mean(integral_lam,3);

end

psi_000 = mean(psi_000,3);

for i=1:45
psi_000_hzav(46-i,:) = (-1*psi_000(i,:) + psi_000(91-i,:))./2;
end

save('/project/rg312/mat_files/chapter2_variables/psi_tav_000.mat','psi_000','psi_000_hzav')
