...
T_zav_th(:,k)=theta_zav_th(:,k).*convthetatoT(k,1);
...
dthetadp_th = gradient(theta_zav_th,-4000);
[moo,dthetady_th] = gradient(theta_zav_th,pi./90);
dudp_th = gradient(uE_zav_th,-4000);
dudz_th = -g.*rho_th.*dudp_th;
Nsq_th = - g.^2 .* rho_th .* dthetadp_th ./theta_zav_th;
eady_th = 0.31.*f./sqrt(Nsq_th) .*dudz_th; 
eadyt_th = -0.31.*g./sqrt(Nsq_th)./theta_zav_th .*dthetady_th./a;
...
[a,b]=max(eady_000_full_hzav);
y_000 = yi(b+45);
[a,b]=max(eady_010_full_hzav);
y_010 = yi(b+45);
[a,b]=max(eady_025_full_hzav);
y_025 = yi(b+45);
[a,b]=max(eady_050_full_hzav);
y_050 = yi(b+45);
[a,b]=max(eady_th_full_hzav);
y_th = yi(b+45);
[a,b]=max(eady_075_full_hzav);
y_075 = yi(b+45);
[a,b]=max(eady_100_full_hzav(20:45));
y_100 = yi(b+65);
[a,b]=max(eady_125_full_hzav(20:45));
y_125 = yi(b+65);
[a,b]=max(eady_150_full_hzav(20:45));
y_150 = yi(b+65);

save('/project/rg312/mat_files/chapter2_variables/eady_peaks.mat', 'y_000', 'y_010', 'y_025', 'y_050', 'y_th', 'y_075', 'y_100', 'y_125', 'y_150')
...
legend('dry','010','025','050','tropheat','075','wet','125','150','Location','eastoutside')
