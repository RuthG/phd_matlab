...
load(['/project/rg312/mat_files/snapshot_data_final/run_th/vN_th_' num2str(j) '.mat'])
...
'Take time average'
psi_th(:,:,j) = mean(integral_lam,3);

end

psi_th = mean(psi_th,3);

for i=1:45
psi_th_hzav(46-i,:) = (-1*psi_th(i,:) + psi_th(91-i,:))./2;
end

save('/project/rg312/mat_files/chapter2_variables/psi_tav_th.mat','psi_th','psi_th_hzav')
