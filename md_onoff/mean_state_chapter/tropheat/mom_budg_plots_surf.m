...
load('/project/rg312/mat_files/chapter2_variables/mom_budg_terms_th.mat','C_total_surf','C_zonal_surf','C_eddy_surf','tauE_hzav','fvN_vint_surf')
C_total_th = C_total_surf;
C_zonal_th = C_zonal_surf;
C_eddy_th = C_eddy_surf;
tauE_hzav_th = tauE_hzav;
fvN_vint_surf_th = fvN_vint_surf;
...
plot(yi(46:90),fvN_vint_surf_th,'b')
