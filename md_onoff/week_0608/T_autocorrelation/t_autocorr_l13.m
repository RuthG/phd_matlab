tic
t_ac_000 = t_autocorr_l13_fun('000');
toc
'000'
t_ac_010 = t_autocorr_l13_fun('010');
'010'
t_ac_025 = t_autocorr_l13_fun('025');
'025'
t_ac_050 = t_autocorr_l13_fun('050');
'050'
t_ac_075 = t_autocorr_l13_fun('075');
'075'
t_ac_100 = t_autocorr_l13_fun('100');
'100'
...
xlabel('Longitude')
ylabel('Latitude')
print('-dpng',['t_ac_000_l13_' num2str(i) '.png'])
...
xlabel('Longitude')
ylabel('Latitude')
print('-dpng',['t_ac_010_l13_' num2str(i) '.png'])
...
xlabel('Longitude')
ylabel('Latitude')
print('-dpng',['t_ac_025_l13_' num2str(i) '.png'])
...
xlabel('Longitude')
ylabel('Latitude')
print('-dpng',['t_ac_050_l13_' num2str(i) '.png'])
...
xlabel('Longitude')
ylabel('Latitude')
print('-dpng',['t_ac_075_l13_' num2str(i) '.png'])
...
xlabel('Longitude')
ylabel('Latitude')
print('-dpng',['t_ac_100_l13_' num2str(i) '.png'])
