%load arnaud diag and v't' for 050 run and start thinking about how to handle composite
...
htrt_ll_050 = cube2latlon(xc,yc,htrt_050,xi,yi);
...
[htrtt_comp,check0] = composite_fun_timelag(peaks_050,fd_thresh_050,htrtt_ed_n,htrtt_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/htrtt_050.mat');
x=-34:2:34;
...
hold on
[C,h] = contour(x,rC./100,nanmean(htrtt_comp,3)',[-1050:1050:1050],'Color',[0.6 0.6 0.6],'LineWidth',2);
xlabel('Longitude','FontSize',15)
ylabel('Pressure, hPa','FontSize',15)
title('0.5e_{s0}')
print('-dpng','htrtt_050.png')
hold off
