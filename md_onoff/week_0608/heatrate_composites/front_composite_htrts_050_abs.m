...
htrt_n = htrt_ll_050(:,x050n-7:x050n+7,:,:);
htrt_s = htrt_ll_050(:,x050s-7:x050s+7,:,:);
clear('htrt_ll_050','htrt_ll_tav_050')
[htrt_comp,check0] = composite_fun_timelag(peaks_050,fd_thresh_050,htrt_n,htrt_s,0,'/project/rg312/mat_files/front_diag_composite_data/htrt_abs_050.mat');
x=-34:2:34;
...
radht_n = radht_ll_050(:,x050n-7:x050n+7,:,:);
radht_s = radht_ll_050(:,x050s-7:x050s+7,:,:);
clear('radht_ll_050','radht_ll_tav_050')
[radht_comp,check0] = composite_fun_timelag(peaks_050,fd_thresh_050,radht_n,radht_s,0,'/project/rg312/mat_files/front_diag_composite_data/radht_abs_050.mat');
...
cndht_n = cndht_ll_050(:,x050n-7:x050n+7,:,:);
cndht_s = cndht_ll_050(:,x050s-7:x050s+7,:,:);
clear('cndht_ll_050','cndht_ll_tav_050')
[cndht_comp,check0] = composite_fun_timelag(peaks_050,fd_thresh_050,cndht_n,cndht_s,0,'/project/rg312/mat_files/front_diag_composite_data/cndht_abs_050.mat');
...
cnvht_n = cnvht_ll_050(:,x050n-7:x050n+7,:,:);
cnvht_s = cnvht_ll_050(:,x050s-7:x050s+7,:,:);
clear('cnvht_ll_050','cnvht_ll_tav_050')
[cnvht_comp,check0] = composite_fun_timelag(peaks_050,fd_thresh_050,cnvht_n,cnvht_s,0,'/project/rg312/mat_files/front_diag_composite_data/cnvht_abs_050.mat');
...
difht_n = difht_ll_050(:,x050n-7:x050n+7,:,:);
difht_s = difht_ll_050(:,x050s-7:x050s+7,:,:);
clear('difht_ll_050','difht_ll_tav_050')
[difht_comp,check0] = composite_fun_timelag(peaks_050,fd_thresh_050,difht_n,difht_s,0,'/project/rg312/mat_files/front_diag_composite_data/difht_abs_050.mat');
