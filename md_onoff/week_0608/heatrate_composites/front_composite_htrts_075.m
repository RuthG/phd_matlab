...
htrt_ll_075 = cube2latlon(xc,yc,htrt_075,xi,yi).*86400;
...
[htrt_comp,check0] = composite_fun_timelag(peaks_075,fd_thresh_075,htrt_ed_n,htrt_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/htrt_075.mat');
x=-34:2:34;
...
radht_ll_075 = cube2latlon(xc,yc,radht_075,xi,yi).*86400;
radht_ll_tav_075 = repmat(mean(radht_ll_075,4),[1 1 1 720]);
radht_ed_ll_075 = radht_ll_075 - radht_ll_tav_075;
radht_ed_n = radht_ed_ll_075(:,x075n-7:x075n+7,:,:);
radht_ed_s = radht_ed_ll_075(:,x075s-7:x075s+7,:,:);
clear('radht_ll_075','radht_ll_tav_075','radht_ed_ll_075')
[radht_comp,check0] = composite_fun_timelag(peaks_075,fd_thresh_075,radht_ed_n,radht_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/radht_075.mat');
...
cndht_ll_075 = cube2latlon(xc,yc,cndht_075,xi,yi).*86400;
cndht_ll_tav_075 = repmat(mean(cndht_ll_075,4),[1 1 1 720]);
cndht_ed_ll_075 = cndht_ll_075 - cndht_ll_tav_075;
cndht_ed_n = cndht_ed_ll_075(:,x075n-7:x075n+7,:,:);
cndht_ed_s = cndht_ed_ll_075(:,x075s-7:x075s+7,:,:);
clear('cndht_ll_075','cndht_ll_tav_075','cndht_ed_ll_075')
[cndht_comp,check0] = composite_fun_timelag(peaks_075,fd_thresh_075,cndht_ed_n,cndht_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/cndht_075.mat');
...
cnvht_ll_075 = cube2latlon(xc,yc,cnvht_075,xi,yi).*86400;
cnvht_ll_tav_075 = repmat(mean(cnvht_ll_075,4),[1 1 1 720]);
cnvht_ed_ll_075 = cnvht_ll_075 - cnvht_ll_tav_075;
cnvht_ed_n = cnvht_ed_ll_075(:,x075n-7:x075n+7,:,:);
cnvht_ed_s = cnvht_ed_ll_075(:,x075s-7:x075s+7,:,:);
clear('cnvht_ll_075','cnvht_ll_tav_075','cnvht_ed_ll_075')
[cnvht_comp,check0] = composite_fun_timelag(peaks_075,fd_thresh_075,cnvht_ed_n,cnvht_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/cnvht_075.mat');
...
difht_ll_075 = cube2latlon(xc,yc,difht_075,xi,yi).*86400;
difht_ll_tav_075 = repmat(mean(difht_ll_075,4),[1 1 1 720]);
difht_ed_ll_075 = difht_ll_075 - difht_ll_tav_075;
difht_ed_n = difht_ed_ll_075(:,x075n-7:x075n+7,:,:);
difht_ed_s = difht_ed_ll_075(:,x075s-7:x075s+7,:,:);
clear('difht_ll_075','difht_ll_tav_075','difht_ed_ll_075')
[difht_comp,check0] = composite_fun_timelag(peaks_075,fd_thresh_075,difht_ed_n,difht_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/difht_075.mat');
