...
print('-dpng',['cnvht_hist_1pos_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_2pos_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_3pos_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_4pos_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_5pos_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_widepos_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_1neg_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_2neg_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_3neg_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_4neg_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_5neg_' run '.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_wideneg_' run '.png'])
