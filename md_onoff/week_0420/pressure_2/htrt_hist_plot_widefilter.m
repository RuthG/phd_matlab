...
htrt_000_ll = squeeze(cube2latlon(xc,yc,htrt_000(:,:,2,1:719),xi,yi)).*86400;
...
t_000_ll = squeeze(cube2latlon(xc,yc,t_000(:,:,2,1:719),xi,yi));
...
htrt_100_ll = squeeze(cube2latlon(xc,yc,htrt_100(:,:,2,1:719),xi,yi)).*86400;
...
t_100_ll = squeeze(cube2latlon(xc,yc,t_100(:,:,2,1:719),xi,yi));
