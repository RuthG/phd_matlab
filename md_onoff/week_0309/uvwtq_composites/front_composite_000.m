...
load('/project/rg312/mat_files/front_diag_full_000.mat')
...
w_ll_000 = cube2latlon(xc,yc,w_000,xi,yi);
w_ll_tav_000 = repmat(mean(w_ll_000,4),[1 1 1 720]);
w_ed_ll_000 = w_ll_000 - w_ll_tav_000;
w_n = w_ll_000(:,x000n-7:x000n+7,:,:);
w_s = w_ll_000(:,x000s-7:x000s+7,:,:);
w_ed_n = w_ed_ll_000(:,x000n-7:x000n+7,:,:);
w_ed_s = w_ed_ll_000(:,x000s-7:x000s+7,:,:);
clear('w_ll_000','w_ll_tav_000','w_ed_ll_000')
[w_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,w_n,w_s,0,'/project/rg312/mat_files/front_diag_composite_data/w_000.mat');
[w_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,w_ed_n,w_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/w_ed_000.mat');
...
t_ll_tav_000 = repmat(mean(t_ll_000,4),[1 1 1 720]);
t_ed_ll_000 = t_ll_000 - t_ll_tav_000;
t_n = t_ll_000(:,x000n-7:x000n+7,:,:);
t_s = t_ll_000(:,x000s-7:x000s+7,:,:);
t_ed_n = t_ed_ll_000(:,x000n-7:x000n+7,:,:);
t_ed_s = t_ed_ll_000(:,x000s-7:x000s+7,:,:);
clear('t_ll_000','t_ll_tav_000')
[t_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,t_n,t_s,0,'/project/rg312/mat_files/front_diag_composite_data/t_000.mat');
[t_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,t_ed_n,t_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/t_ed_000.mat');
...
vN_ll_tav_000 = repmat(mean(vN_ll_000,4),[1 1 1 720]);
vN_ed_ll_000 = vN_ll_000 - vN_ll_tav_000;
vNt_ed_ll_000 = vN_ed_ll_000.*t_ed_ll_000;
vN_n = vN_ll_000(:,x000n-7:x000n+7,:,:);
vN_s = -1.*vN_ll_000(:,x000s-7:x000s+7,:,:);
vN_ed_n = vN_ed_ll_000(:,x000n-7:x000n+7,:,:);
vN_ed_s = -1.*vN_ed_ll_000(:,x000s-7:x000s+7,:,:);
vNt_ed_n = vNt_ed_ll_000(:,x000n-7:x000n+7,:,:);
vNt_ed_s = -1.*vNt_ed_ll_000(:,x000s-7:x000s+7,:,:);
clear('vN_ll_000','vN_ll_tav_000','vN_ed_ll_000','t_ed_ll_000')
[vN_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,vN_n,vN_s,0,'/project/rg312/mat_files/front_diag_composite_data/vN_000.mat');
[vN_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,vN_ed_n,vN_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/vN_ed_000.mat');
[vNt_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,vNt_ed_n,vNt_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/vNt_ed_000.mat');
...
load('/project/rg312/mat_files/snapshot_data/q_snapshots.mat','q_000')
q_ll_000 = cube2latlon(xc,yc,q_000,xi,yi);
q_ll_tav_000 = repmat(mean(q_ll_000,4),[1 1 1 720]);
q_ed_ll_000 = q_ll_000 - q_ll_tav_000;
q_n = q_ll_000(:,x000n-7:x000n+7,:,:);
q_s = q_ll_000(:,x000s-7:x000s+7,:,:);
q_ed_n = q_ed_ll_000(:,x000n-7:x000n+7,:,:);
q_ed_s = q_ed_ll_000(:,x000s-7:x000s+7,:,:);
clear('q_ll_000','q_ll_tav_000','q_ed_ll_000')
[q_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,q_n,q_s,0,'/project/rg312/mat_files/front_diag_composite_data/q_000.mat');
[q_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,q_ed_n,q_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/q_ed_000.mat');
...
load('/project/rg312/mat_files/snapshot_data/uE_snapshots.mat','uE_000')
uE_ll_000 = cube2latlon(xc,yc,uE_000,xi,yi);
uE_ll_tav_000 = repmat(mean(uE_ll_000,4),[1 1 1 720]);
uE_ed_ll_000 = uE_ll_000 - uE_ll_tav_000;
uE_n = uE_ll_000(:,x000n-7:x000n+7,:,:);
uE_s = uE_ll_000(:,x000s-7:x000s+7,:,:);
uE_ed_n = uE_ed_ll_000(:,x000n-7:x000n+7,:,:);
uE_ed_s = uE_ed_ll_000(:,x000s-7:x000s+7,:,:);
clear('uE_ll_000','uE_ll_tav_000','uE_ed_ll_000')
[uE_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,uE_n,uE_s,0,'/project/rg312/mat_files/front_diag_composite_data/uE_000.mat');
[uE_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,uE_ed_n,uE_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/uE_ed_000.mat');
...
theta_n = theta_ll_000(:,x000n-7:x000n+7,:,:);
theta_s = theta_ll_000(:,x000s-7:x000s+7,:,:);
...
[theta_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,theta_n,theta_s,0,'/project/rg312/mat_files/front_diag_composite_data/theta_000.mat');
[theta_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,theta_ed_n,theta_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/theta_ed_000.mat');
