...
[w_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,w_n,w_s,0,'/project/rg312/mat_files/front_diag_composite_data/w_100.mat');
[w_ed_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,w_ed_n,w_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/w_ed_100.mat');
...
[t_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,t_n,t_s,0,'/project/rg312/mat_files/front_diag_composite_data/t_100.mat');
[t_ed_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,t_ed_n,t_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/t_ed_100.mat');
...
[vN_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,vN_n,vN_s,0,'/project/rg312/mat_files/front_diag_composite_data/vN_100.mat');
[vN_ed_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,vN_ed_n,vN_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/vN_ed_100.mat');
[vNt_ed_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,vNt_ed_n,vNt_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/vNt_ed_100.mat');
...
load('/project/rg312/mat_files/snapshot_data/q_snapshots.mat','q_100')
...
[q_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,q_n,q_s,0,'/project/rg312/mat_files/front_diag_composite_data/q_100.mat');
[q_ed_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,q_ed_n,q_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/q_ed_100.mat');
...
[uE_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,uE_n,uE_s,0,'/project/rg312/mat_files/front_diag_composite_data/uE_100.mat');
[uE_ed_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,uE_ed_n,uE_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/uE_ed_100.mat');
...
[theta_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,theta_n,theta_s,0,'/project/rg312/mat_files/front_diag_composite_data/theta_100.mat');
[theta_ed_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,theta_ed_n,theta_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/theta_ed_100.mat');
