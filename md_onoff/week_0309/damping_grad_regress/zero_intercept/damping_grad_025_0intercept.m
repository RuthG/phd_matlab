...
m_neg = fminsearch(@(m_neg) damping_tscale_fun_0intercept(m_neg,tser,htrtser),[-2])

htrtser = htrt_ed_series_masked_pos;
tser = t_ed_series_masked_pos;
m_pos = fminsearch(@(m_pos) damping_tscale_fun_0intercept(m_pos,tser,htrtser),[-2])

radhtser = radht_ed_series_masked_neg;
tser = t_ed_series_masked_neg;
m_neg_radht = fminsearch(@(m_neg) damping_tscale_fun_0intercept(m_neg,tser,radhtser),[-2])

radhtser = radht_ed_series_masked_pos;
tser = t_ed_series_masked_pos;
m_pos_radht = fminsearch(@(m_pos) damping_tscale_fun_0intercept(m_pos,tser,radhtser),[-2])

cndhtser = cndht_ed_series_masked_neg;
tser = t_ed_series_masked_neg;
m_neg_cndht = fminsearch(@(m_neg) damping_tscale_fun_0intercept(m_neg,tser,cndhtser),[-2])

cndhtser = cndht_ed_series_masked_pos;
tser = t_ed_series_masked_pos;
m_pos_cndht = fminsearch(@(m_pos) damping_tscale_fun_0intercept(m_pos,tser,cndhtser),[-2])

cnvhtser = cnvht_ed_series_masked_neg;
tser = t_ed_series_masked_neg;
m_neg_cnvht = fminsearch(@(m_neg) damping_tscale_fun_0intercept(m_neg,tser,cnvhtser),[-2])

cnvhtser = cnvht_ed_series_masked_pos;
tser = t_ed_series_masked_pos;
m_pos_cnvht = fminsearch(@(m_pos) damping_tscale_fun_0intercept(m_pos,tser,cnvhtser),[-2])

difhtser = difht_ed_series_masked_neg;
tser = t_ed_series_masked_neg;
m_neg_difht = fminsearch(@(m_neg) damping_tscale_fun_0intercept(m_neg,tser,difhtser),[-2])

difhtser = difht_ed_series_masked_pos;
tser = t_ed_series_masked_pos;
m_pos_difht = fminsearch(@(m_pos) damping_tscale_fun_0intercept(m_pos,tser,difhtser),[-2])
...
print('-dpng','thtrt_fit_025_0int.png')
...
print('-dpng','tradht_fit_025_0int.png')
...
print('-dpng','tcndht_fit_025_0int.png')
...
print('-dpng','tcnvht_fit_025_0int.png')
...
print('-dpng','tdifht_fit_025_0int.png')

save('/project/rg312/mat_files/damping_grad_025.mat','m_neg','m_pos','m_neg_radht','m_pos_radht','m_neg_cndht','m_pos_cndht','m_neg_cnvht','m_pos_cnvht','m_neg_difht','m_pos_difht')
