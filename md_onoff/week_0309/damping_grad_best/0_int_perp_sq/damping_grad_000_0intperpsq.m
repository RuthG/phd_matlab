...
print('-dpng','thtrt_fit_000_0int.png')
...
print('-dpng','tradht_fit_000_0int.png')
...
print('-dpng','tcndht_fit_000_0int.png')
...
print('-dpng','tcnvht_fit_000_0int.png')
...
print('-dpng','tdifht_fit_000_0int.png')

save('/project/rg312/mat_files/damping_grad_000_0intperpsq.mat','m_neg','m_pos','m_neg_radht','m_pos_radht','m_neg_cndht','m_pos_cndht','m_neg_cnvht','m_pos_cnvht','m_neg_difht','m_pos_difht')
