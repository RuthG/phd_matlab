...
tser = t_ed_series_masked_neg;
m_neg_radht = fminsearch(@(m_neg_radht) damping_tscale_fun(m_neg_radht,tser,radhtser),[-20,-100])

radhtser = radht_ed_series_masked_pos;
tser = t_ed_series_masked_pos;
m_pos_radht = fminsearch(@(m_pos_radht) damping_tscale_fun(m_pos_radht,tser,radhtser),[-20,-100])

cndhtser = cndht_ed_series_masked_neg;
tser = t_ed_series_masked_neg;
m_neg_cndht = fminsearch(@(m_neg_cndht) damping_tscale_fun(m_neg_cndht,tser,cndhtser),[-20,-100])

cndhtser = cndht_ed_series_masked_pos;
tser = t_ed_series_masked_pos;
m_pos_cndht = fminsearch(@(m_pos_cndht) damping_tscale_fun(m_pos_cndht,tser,cndhtser),[-20,-100])

cnvhtser = cnvht_ed_series_masked_neg;
tser = t_ed_series_masked_neg;
m_neg_cnvht = fminsearch(@(m_neg_cnvht) damping_tscale_fun(m_neg_cnvht,tser,cnvhtser),[-20,-100])

cnvhtser = cnvht_ed_series_masked_pos;
tser = t_ed_series_masked_pos;
m_pos_cnvht = fminsearch(@(m_pos_cnvht) damping_tscale_fun(m_pos_cnvht,tser,cnvhtser),[-20,-100])

difhtser = difht_ed_series_masked_neg;
tser = t_ed_series_masked_neg;
m_neg_difht = fminsearch(@(m_neg_difht) damping_tscale_fun(m_neg_difht,tser,difhtser),[-20,-100])

difhtser = difht_ed_series_masked_pos;
tser = t_ed_series_masked_pos;
m_pos_difht = fminsearch(@(m_pos_difht) damping_tscale_fun(m_pos_difht,tser,difhtser),[-20,-100])
...
print('-dpng','thtrt_fit_010_pfit.png')
...
print('-dpng','tradht_fit_010_pfit.png')
...
print('-dpng','tcndht_fit_010_pfit.png')
...
print('-dpng','tcnvht_fit_010_pfit.png')
...
print('-dpng','tdifht_fit_010_pfit.png')

save('/project/rg312/mat_files/damping_grad_010_perpsq.mat','m_neg','m_pos','m_neg_radht','m_pos_radht','m_neg_cndht','m_pos_cndht','m_neg_cnvht','m_pos_cnvht','m_neg_difht','m_pos_difht')
