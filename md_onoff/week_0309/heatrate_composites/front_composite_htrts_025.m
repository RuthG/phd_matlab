...
[htrt_comp,check0] = composite_fun_timelag(peaks_025,fd_thresh_025,htrt_ed_n,htrt_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/htrt_025.mat');
x=-34:2:34;
...
load('/project/rg312/mat_files/heat_rates.mat','radht_025')
radht_ll_025 = cube2latlon(xc,yc,radht_025,xi,yi).*86400;
radht_ll_tav_025 = repmat(mean(radht_ll_025,4),[1 1 1 720]);
radht_ed_ll_025 = radht_ll_025 - radht_ll_tav_025;
radht_ed_n = radht_ed_ll_025(:,x025n-7:x025n+7,:,:);
radht_ed_s = radht_ed_ll_025(:,x025s-7:x025s+7,:,:);
clear('radht_ll_025','radht_ll_tav_025','radht_ed_ll_025')
[radht_comp,check0] = composite_fun_timelag(peaks_025,fd_thresh_025,radht_ed_n,radht_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/radht_025.mat');
...
load('/project/rg312/mat_files/heat_rates.mat','cndht_025')
cndht_ll_025 = cube2latlon(xc,yc,cndht_025,xi,yi).*86400;
cndht_ll_tav_025 = repmat(mean(cndht_ll_025,4),[1 1 1 720]);
cndht_ed_ll_025 = cndht_ll_025 - cndht_ll_tav_025;
cndht_ed_n = cndht_ed_ll_025(:,x025n-7:x025n+7,:,:);
cndht_ed_s = cndht_ed_ll_025(:,x025s-7:x025s+7,:,:);
clear('cndht_ll_025','cndht_ll_tav_025','cndht_ed_ll_025')
[cndht_comp,check0] = composite_fun_timelag(peaks_025,fd_thresh_025,cndht_ed_n,cndht_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/cndht_025.mat');
...
load('/project/rg312/mat_files/heat_rates.mat','cnvht_025')
cnvht_ll_025 = cube2latlon(xc,yc,cnvht_025,xi,yi).*86400;
cnvht_ll_tav_025 = repmat(mean(cnvht_ll_025,4),[1 1 1 720]);
cnvht_ed_ll_025 = cnvht_ll_025 - cnvht_ll_tav_025;
cnvht_ed_n = cnvht_ed_ll_025(:,x025n-7:x025n+7,:,:);
cnvht_ed_s = cnvht_ed_ll_025(:,x025s-7:x025s+7,:,:);
clear('cnvht_ll_025','cnvht_ll_tav_025','cnvht_ed_ll_025')
[cnvht_comp,check0] = composite_fun_timelag(peaks_025,fd_thresh_025,cnvht_ed_n,cnvht_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/cnvht_025.mat');
...
load('/project/rg312/mat_files/heat_rates.mat','difht_025')
difht_ll_025 = cube2latlon(xc,yc,difht_025,xi,yi).*86400;
difht_ll_tav_025 = repmat(mean(difht_ll_025,4),[1 1 1 720]);
difht_ed_ll_025 = difht_ll_025 - difht_ll_tav_025;
difht_ed_n = difht_ed_ll_025(:,x025n-7:x025n+7,:,:);
difht_ed_s = difht_ed_ll_025(:,x025s-7:x025s+7,:,:);
clear('difht_ll_025','difht_ll_tav_025','difht_ed_ll_025')
[difht_comp,check0] = composite_fun_timelag(peaks_025,fd_thresh_025,difht_ed_n,difht_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/difht_025.mat');
