...
for i=1:44
blev_press_000(i) = rC(b_lev_000(i+45))./100;
blev_press_010(i) = rC(b_lev_010(i+45))./100;
blev_press_025(i) = rC(b_lev_025(i+45))./100;
blev_press_050(i) = rC(b_lev_050(i+45))./100;
blev_press_075(i) = rC(b_lev_075(i+45))./100;
blev_press_100(i) = rC(b_lev_100(i+45))./100;
blev_press_125(i) = rC(b_lev_125(i+45))./100;
blev_press_150(i) = rC(b_lev_150(i+45))./100;

trop_press_000(i) = rC(trop_lev_000(i+45))./100;
trop_press_010(i) = rC(trop_lev_010(i+45))./100;
trop_press_025(i) = rC(trop_lev_025(i+45))./100;
trop_press_050(i) = rC(trop_lev_050(i+45))./100;
trop_press_075(i) = rC(trop_lev_075(i+45))./100;
trop_press_100(i) = rC(trop_lev_100(i+45))./100;
trop_press_125(i) = rC(trop_lev_125(i+45))./100;
trop_press_150(i) = rC(trop_lev_150(i+45))./100;
end
...
hold on
plot(yi(46:89),blev_press_000,'k','LineWidth',2)
plot(yi(46:89),trop_press_000,'k','LineWidth',2)
hold off
title('0.0')
...
set(gca,'YDir','reverse','FontSize',10)
hold on
plot(yi(46:89),blev_press_010,'k','LineWidth',2)
plot(yi(46:89),trop_press_010,'k','LineWidth',2)
hold off
title('0.1')
...
set(gca,'YDir','reverse','FontSize',10)
hold on
plot(yi(46:89),blev_press_025,'k','LineWidth',2)
plot(yi(46:89),trop_press_025,'k','LineWidth',2)
hold off
title('0.25')
...
set(gca,'YDir','reverse','FontSize',10)
hold on
plot(yi(46:89),blev_press_050,'k','LineWidth',2)
plot(yi(46:89),trop_press_050,'k','LineWidth',2)
hold off
title('0.5')
...
hold on
plot(yi(46:89),blev_press_075,'k','LineWidth',2)
plot(yi(46:89),trop_press_075,'k','LineWidth',2)
hold off
title('0.75')
...
xlabel('Latitude','FontSize',12)
hold on
plot(yi(46:89),blev_press_100,'k','LineWidth',2)
plot(yi(46:89),trop_press_100,'k','LineWidth',2)
hold off
title('1.0')
...
xlabel('Latitude','FontSize',12)
hold on
plot(yi(46:89),blev_press_125,'k','LineWidth',2)
plot(yi(46:89),trop_press_125,'k','LineWidth',2)
hold off
title('1.25')
...
xlabel('Latitude','FontSize',12)
hold on
plot(yi(46:89),blev_press_150,'k','LineWidth',2)
plot(yi(46:89),trop_press_150,'k','LineWidth',2)
hold off
title('1.5')


print('-dpdf','theta_trop_pbl.pdf')
