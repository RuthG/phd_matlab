...
function out = difht_tfiltered_hists_l2_fun(run)
...
difht_ll = squeeze(cube2latlon(xc,yc,difht_cs(:,:,2,1:719),xi,yi)).*86400;
...
print('-dpng',['difht_hist_1pos_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_2pos_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_3pos_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_4pos_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_5pos_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_widepos_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_1neg_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_2neg_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_3neg_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_4neg_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_5neg_' run '_l2.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['difht_hist_wideneg_' run '_l2.png'])
