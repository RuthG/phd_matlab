...
function out = cnvht_tfiltered_hists_l10_fun(run)
...
cnvht_ll = squeeze(cube2latlon(xc,yc,cnvht_cs(:,:,10,1:719),xi,yi)).*86400;
...
t_cs = t_cs.(t_var);
t_ll = squeeze(cube2latlon(xc,yc,t_cs(:,:,10,1:719),xi,yi));
...
print('-dpng',['cnvht_hist_1pos_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_2pos_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_3pos_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_4pos_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_5pos_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_widepos_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_1neg_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_2neg_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_3neg_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_4neg_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_5neg_' run '_l10.png'])
...
ylabel('Probability')
title([num2str(str2num(run)./100) 'e_{s0}'])
print('-dpng',['cnvht_hist_wideneg_' run '_l10.png'])
