...
tt_ed_pav = mean(tt_ed_ll(:,:,blev(xn)+1:tlev(xn),:),3);
...
tt_ed_pav_tneg = squeeze(mean(tt_ll_tneg(:,:,blev(xn)+1:tlev(xn),:) ,3));
tt_ed_pav_tpos = squeeze(mean(tt_ll_tpos(:,:,blev(xn)+1:tlev(xn),:) ,3));
