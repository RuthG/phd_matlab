...
htrt_050_skew = skewness(reshape(htrt_ed_050_ll,[numel(htrt_ed_050_ll),1]));
...
htrt_ed_050_counts = hist(reshape(htrt_ed_050_ll,[numel(htrt_ed_050_ll),1]),xbins);
htrt_ed_050_counts_cos(i,:) = htrt_ed_050_counts.*cos(yi(i).*pi./180);

end

htrt_hist = sum(htrt_ed_050_counts_cos,1)./sum(sum(htrt_ed_050_counts_cos));
...
save('/project/rg312/mat_files/htrt_hists_asym_050.mat')
