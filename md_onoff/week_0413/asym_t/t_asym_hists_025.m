...
t_025_skew = skewness(reshape(t_ed_025_ll,[numel(t_ed_025_ll),1]));
...
t_ed_025_counts = hist(reshape(t_ed_025_ll,[numel(t_ed_025_ll),1]),xbins);
t_ed_025_counts_cos(i,:) = t_ed_025_counts.*cos(yi(i).*pi./180);

end

t_hist = sum(t_ed_025_counts_cos,1)./sum(sum(t_ed_025_counts_cos));
...
save('/project/rg312/mat_files/t_hists_asym_025.mat')
