...
t_100_skew = skewness(reshape(t_ed_100_ll,[numel(t_ed_100_ll),1]));
...
t_ed_100_counts = hist(reshape(t_ed_100_ll,[numel(t_ed_100_ll),1]),xbins);
t_ed_100_counts_cos(i,:) = t_ed_100_counts.*cos(yi(i).*pi./180);

end

t_hist = sum(t_ed_100_counts_cos,1)./sum(sum(t_ed_100_counts_cos));
...
save('/project/rg312/mat_files/t_hists_asym_100.mat')
