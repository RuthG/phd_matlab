...
t_010_skew = skewness(reshape(t_ed_010_ll,[numel(t_ed_010_ll),1]));
...
t_ed_010_counts = hist(reshape(t_ed_010_ll,[numel(t_ed_010_ll),1]),xbins);
t_ed_010_counts_cos(i,:) = t_ed_010_counts.*cos(yi(i).*pi./180);

end

t_hist = sum(t_ed_010_counts_cos,1)./sum(sum(t_ed_010_counts_cos));
...
save('/project/rg312/mat_files/t_hists_asym_010.mat')
