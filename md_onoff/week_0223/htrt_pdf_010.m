...
ylabel('Probability')
title('PDF of eddy diabatic heating associated with warm sector, 0.1 e_{s0}')
print('-dpng','warm_htrt_pdf_010.png')
...
xlabel('Total eddy diabatic heating, K/day')
ylabel('Probability')
title('PDF of eddy diabatic heating associated with cold sector, 0.1 e_{s0}')
print('-dpng','cold_htrt_pdf_010.png')
...
ylabel('Probability')
title('PDF of eddy diabatic heating associated with warm sector, 0.1 e_{s0}')
print('-dpng','warm_radht_pdf_010.png')
...
ylabel('Probability')
title('PDF of eddy diabatic heating associated with cold sector, 0.1 e_{s0}')
print('-dpng','cold_radht_pdf_010.png')
...
ylabel('Probability')
title('PDF of eddy diabatic heating associated with warm sector, 0.1 e_{s0}')
print('-dpng','warm_difht_pdf_010.png')
...
ylabel('Probability')
title('PDF of eddy diabatic heating associated with cold sector, 0.1 e_{s0}')
print('-dpng','cold_difht_pdf_010.png')
...
ylabel('Probability')
title('PDF of eddy diabatic heating associated with warm sector, 0.1 e_{s0}')
print('-dpng','warm_cndht_pdf_010.png')
...
ylabel('Probability')
title('PDF of eddy diabatic heating associated with cold sector, 0.1 e_{s0}')
print('-dpng','cold_cndht_pdf_010.png')
...
ylabel('Probability')
title('PDF of eddy diabatic heating associated with warm sector, 0.1 e_{s0}')
print('-dpng','warm_cnvht_pdf_010.png')
...
ylabel('Probability')
title('PDF of eddy diabatic heating associated with cold sector, 0.1 e_{s0}')
print('-dpng','cold_cnvht_pdf_010.png')
