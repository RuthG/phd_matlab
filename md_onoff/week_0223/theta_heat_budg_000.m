...
figure
v=-15:1:15;
[C,h] = contourf(xi,yi,htrt_000_ll(:,:,5)' + wdthetadp_000(:,:,5)' + udthetadx_000(:,:,5)' + vdthetady_000(:,:,5)',v);
set(h,'LineColor','none')
set(gca,'FontSize',15)
hold on
v = 0.1:0.1:1;
...
caxis([-15 15]);
colorbar
title('Sum of total heat budget terms, K/day, 0es0');
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','tot_heat_budg_sum_000.png')

figure
v=-15:1:15;
[C,h] = contourf(xi,yi,htrt_000_ll_tav(:,:,5)' + wdthetadp_000_tav(:,:,5)' + udthetadx_000_tav(:,:,5)' + vdthetady_000_tav(:,:,5)',v);
set(h,'LineColor','none')
set(gca,'FontSize',15)
hold on
v = 0.1:0.1:1;
...
caxis([-15 15]);
colorbar
title('Sum of time mean heat budget terms, K/day, 0es0');
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','tav_heat_budg_sum_000.png')


figure
v=-15:1:15;
[C,h] = contourf(xi,yi,htrt_ed_000_ll(:,:,5)' + w_ed_dthetadp_000(:,:,5)' + wdtheta_ed_dp_000(:,:,5)' + w_ed_dtheta_ed_dp_000(:,:,5)' + u_ed_dthetadx_000(:,:,5)' + udtheta_ed_dx_000(:,:,5)' + u_ed_dtheta_ed_dx_000(:,:,5)' + v_ed_dthetady_000(:,:,5)' + vdtheta_ed_dy_000(:,:,5)' + v_ed_dtheta_ed_dy_000(:,:,5)',v);
set(h,'LineColor','none')
set(gca,'FontSize',15)
hold on
v = 0.1:0.1:1;
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_total/wv_000/htrt_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_tav/wv_000/htrt_tav_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_eddy/wv_000/htrt_ed_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_total/wv_000/udthetadx_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_tav/wv_000/udthetadx_tav_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_eddy/wv_000/udthetapdx_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_eddy/wv_000/updthetadx_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_eddy/wv_000/updtpdx_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_total/wv_000/vdthetady_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_tav/wv_000/vdthetady_tav_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_eddy/wv_000/vdthetapdy_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_eddy/wv_000/vpdthetady_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_eddy/wv_000/vpdthetapdy_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_total/wv_000/wdthetadp_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_tav/wv_000/wdthetadp_tav_000.png')

figure
v=-15:1:15;
[C,h] = contourf(xi,yi,wdtheta_ed_dp_000(:,:,5)',v);
set(h,'LineColor','none')
set(gca,'FontSize',15)
hold on
v = 0.1:0.1:1;
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_eddy/wv_000/wdthetapdp_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_eddy/wv_000/wpdthetadp_000.png')
...
ylabel('Latitude')
xlabel('Longitude')
print('-dpng','heat_budg_eddy/wv_000/wpdthetapdp_000.png')
