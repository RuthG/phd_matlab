...
mag_fac = 1.;
  ...
  for k=1:n;
   sw_wv = exp(0.00422./(solar_tau(:,k) - 0.00324) + 1.681./((solar_tau(:,k) + 0.478).^2));
...
save('/project/rg312/mat_files/radiation_chapter/heating_myscheme_swpole.mat','down','down_win','up','up_win','net','net_win','tdt_lw','tdt_sw','tdt_win','dtrans','dtrans_win','b','b_win','t_surf','b_surf')
