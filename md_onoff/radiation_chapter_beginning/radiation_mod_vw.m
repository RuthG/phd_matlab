...
save('/project/rg312/mat_files/radiation_chapter/heating_myscheme_vw.mat' ,'down','down_win','up','up_win','net','net_win','tdt_lw','tdt_win','dtrans','dtrans_win','b','b_win','q_in','t_in','t_surf','b_surf')
