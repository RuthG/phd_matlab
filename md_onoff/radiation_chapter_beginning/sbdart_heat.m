...
%v=-5:0.25:1.6;
%label = -5:0.25:1.6;
[C,h] = contour(yi(2:89),p./100,heat_lw(2:89,:)',v,'k');
...
%v=-5:0.25:1.6;
%label = -5:0.25:1.6;
[C,h] = contour(yi(2:89),p./100,heat_sw(2:89,:)','k');
clabel(C,h,'FontSize',10);
set(gca,'YDir','reverse','FontSize',10)
xlabel('Latitude','FontSize',12)
ylabel('Pressure, hPa','FontSize',12)
...
v=0:0.2:1.6;
label = 0:0.2:1.6;
[C,h] = contour(yi(2:89),p./100,tdt_up(2:89,:)'.*86400,'k');
clabel(C,h,'FontSize',10);
set(gca,'YDir','reverse','FontSize',10)
xlabel('Latitude','FontSize',12)
%ylabel('Pressure, hPa','FontSize',12)

print('-dpdf','sbdart_heat_up.pdf')
