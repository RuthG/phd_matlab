...
print('-dpng','thtrt_fit_100.png')

save('/project/rg312/mat_files/htrt_t_data_100.mat','slopeneg','offsetneg','slopepos','offsetpos', 'htrt_ed_series_masked_neg','htrt_ed_series_masked_pos','t_ed_series_masked_neg','t_ed_series_masked_pos')
...
xlabel('T'', K')
ylabel('Eddy diabatic heating, K/day')
print('-dpng','thtrt_fit_100_reg.png')
...
print('-dpng','tradht_fit_100_reg.png')
...
print('-dpng','tcndht_fit_100_reg.png')
...
print('-dpng','tcnvht_fit_100_reg.png')
...
print('-dpng','tdifht_fit_100_reg.png')

save('/project/rg312/mat_files/damping_grad_100_0intregress_best.mat','m_neg','m_pos','m_neg_radht','m_pos_radht','m_neg_cndht','m_pos_cndht','m_neg_cnvht','m_pos_cnvht','m_neg_difht','m_pos_difht')
