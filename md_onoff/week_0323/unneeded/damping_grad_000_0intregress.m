...
[a1,b1,slopeneg,offsetneg] = myregress(htrtser',tser',0)

htrtser = htrt_ed_series_masked_pos;
tser = t_ed_series_masked_pos;
[a2,b2,slopepos,offsetpos] = myregress(htrtser',tser',0)
...
hold on
plot([-15, 0],[-15,0].*slopeneg + offsetneg,'r')
plot(t_ed_series_masked_pos,htrt_ed_series_masked_pos,'kx')
plot([0, 15],[0,15].*slopepos + offsetpos,'g')
xlim([-15 15])
ylim([-8 8])
xlabel('T'', K')
ylabel('Eddy diabatic heating, K/day')
print('-dpng','thtrt_fit_000.png')

save('/project/rg312/mat_files/htrt_t_data_000.mat','slopeneg','offsetneg','slopepos','offsetpos', 'htrt_ed_series_masked_neg','htrt_ed_series_masked_pos','t_ed_series_masked_neg','t_ed_series_masked_pos')
...
xlabel('T'', K')
ylabel('Eddy diabatic heating, K/day')
print('-dpng','thtrt_fit_000_reg.png')
...
print('-dpng','tradht_fit_000_reg.png')
...
print('-dpng','tcndht_fit_000_reg.png')
...
print('-dpng','tcnvht_fit_000_reg.png')
...
print('-dpng','tdifht_fit_000_reg.png')

save('/project/rg312/mat_files/damping_grad_000_0intregress_best.mat','m_neg','m_pos','m_neg_radht','m_pos_radht','m_neg_cndht','m_pos_cndht','m_neg_cnvht','m_pos_cnvht','m_neg_difht','m_pos_difht')
