...
t_ll_tneg = t_ed_ll.*t_ed_mask_neg;
t_ll_tpos = t_ed_ll.*t_ed_mask_pos;

t_ll_tzav_000 = squeeze(mean(mean(t_ed_ll,1),4))';
t_ll_tzav_tneg_000 = squeeze(nanmean(nanmean(t_ll_tneg,1),4))';
t_ll_tzav_tpos_000 = squeeze(nanmean(nanmean(t_ll_tpos,1),4))';
...
t_ll_tzav_010 = squeeze(mean(mean(t_ed_ll,1),4))';
t_ll_tzav_tneg_010 = squeeze(nanmean(nanmean(t_ll_tneg,1),4))';
t_ll_tzav_tpos_010 = squeeze(nanmean(nanmean(t_ll_tpos,1),4))';
...
t_ll_tzav_025 = squeeze(mean(mean(t_ed_ll,1),4))';
t_ll_tzav_tneg_025 = squeeze(nanmean(nanmean(t_ll_tneg,1),4))';
t_ll_tzav_tpos_025 = squeeze(nanmean(nanmean(t_ll_tpos,1),4))';
...
t_ll_tzav_050 = squeeze(mean(mean(t_ed_ll,1),4))';
t_ll_tzav_tneg_050 = squeeze(nanmean(nanmean(t_ll_tneg,1),4))';
t_ll_tzav_tpos_050 = squeeze(nanmean(nanmean(t_ll_tpos,1),4))';
...
t_ll_tzav_075 = squeeze(mean(mean(t_ed_ll,1),4))';
t_ll_tzav_tneg_075 = squeeze(nanmean(nanmean(t_ll_tneg,1),4))';
t_ll_tzav_tpos_075 = squeeze(nanmean(nanmean(t_ll_tpos,1),4))';
...
t_ll_tzav_100 = squeeze(mean(mean(t_ed_ll,1),4))';
t_ll_tzav_tneg_100 = squeeze(nanmean(nanmean(t_ll_tneg,1),4))';
t_ll_tzav_tpos_100 = squeeze(nanmean(nanmean(t_ll_tpos,1),4))';
...
t_ll_tzav_125 = squeeze(mean(mean(t_ed_ll,1),4))';
t_ll_tzav_tneg_125 = squeeze(nanmean(nanmean(t_ll_tneg,1),4))';
t_ll_tzav_tpos_125 = squeeze(nanmean(nanmean(t_ll_tpos,1),4))';
...
t_ll_tzav_150 = squeeze(mean(mean(t_ed_ll,1),4))';
t_ll_tzav_tneg_150 = squeeze(nanmean(nanmean(t_ll_tneg,1),4))';
t_ll_tzav_tpos_150 = squeeze(nanmean(nanmean(t_ll_tpos,1),4))';
