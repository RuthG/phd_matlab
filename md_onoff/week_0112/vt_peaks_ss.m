...
peak_dist_100 = zeros(600,1);
  ...
  for k=1:600
  peak_dist_000(k) = peak_dist_000(k) + sum(sum(sum( vt_ed_000n(:,:,4,:) >= vt_bins(k) & vt_ed_000n(:,:,4,:) < vt_bins(k+1)));
  peak_dist_000(k) = peak_dist_000(k) + sum(sum(sum( vt_ed_000s(:,:,4,:) >= vt_bins(k) & vt_ed_000s(:,:,4,:) < vt_bins(k+1)));
  peak_dist_010(k) = peak_dist_010(k) + sum(sum(sum( vt_ed_010n(:,:,4,:) >= vt_bins(k) & vt_ed_010n(:,:,4,:) < vt_bins(k+1)));
  peak_dist_010(k) = peak_dist_010(k) + sum(sum(sum( vt_ed_010s(:,:,4,:) >= vt_bins(k) & vt_ed_010s(:,:,4,:) < vt_bins(k+1)));
  peak_dist_025(k) = peak_dist_025(k) + sum(sum(sum( vt_ed_025n(:,:,4,:) >= vt_bins(k) & vt_ed_025n(:,:,4,:) < vt_bins(k+1)));
  peak_dist_025(k) = peak_dist_025(k) + sum(sum(sum( vt_ed_025s(:,:,4,:) >= vt_bins(k) & vt_ed_025s(:,:,4,:) < vt_bins(k+1)));
  peak_dist_050(k) = peak_dist_050(k) + sum(sum(sum( vt_ed_050n(:,:,4,:) >= vt_bins(k) & vt_ed_050n(:,:,4,:) < vt_bins(k+1)));
  peak_dist_050(k) = peak_dist_050(k) + sum(sum(sum( vt_ed_050s(:,:,4,:) >= vt_bins(k) & vt_ed_050s(:,:,4,:) < vt_bins(k+1)));
  peak_dist_075(k) = peak_dist_075(k) + sum(sum(sum( vt_ed_075n(:,:,4,:) >= vt_bins(k) & vt_ed_075n(:,:,4,:) < vt_bins(k+1)));
  peak_dist_075(k) = peak_dist_075(k) + sum(sum(sum( vt_ed_075s(:,:,4,:) >= vt_bins(k) & vt_ed_075s(:,:,4,:) < vt_bins(k+1)));
  peak_dist_100(k) = peak_dist_100(k) + sum(sum(sum( vt_ed_100n(:,:,4,:) >= vt_bins(k) & vt_ed_100n(:,:,4,:) < vt_bins(k+1)));
  peak_dist_100(k) = peak_dist_100(k) + sum(sum(sum( vt_ed_100s(:,:,4,:) >= vt_bins(k) & vt_ed_100s(:,:,4,:) < vt_bins(k+1)));
  end
