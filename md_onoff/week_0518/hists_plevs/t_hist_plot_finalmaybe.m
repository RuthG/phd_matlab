...
%vN_000_ll = squeeze(cube2latlon(xc,yc,vN_000(:,:,j,1:719),xi,yi));
...
%vN_100_ll = squeeze(cube2latlon(xc,yc,vN_100(:,:,j,1:719),xi,yi));
...
name=['t_hist_plot_l' num2str(j) '.png'];
print('-dpng',name)
...
%wetleg = ['Wet'];
%legend(dryleg, wetleg)
%name=['v_hist_plot_l' num2str(j) '.png'];
%print('-dpng',name)
