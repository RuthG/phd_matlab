...
tott_cs = load(['/project/rg312/mat_files/totttend_100_best.mat'],tottt);
...
htrt_000_ll = squeeze(cube2latlon(xc,yc,htrt_000(:,:,j,1:719),xi,yi)).*86400;
...
t_000_ll = squeeze(cube2latlon(xc,yc,t_000(:,:,j,1:719),xi,yi));
...
htrt_100_ll = squeeze(cube2latlon(xc,yc,htrt_100(:,:,j,1:719),xi,yi)).*86400;
...
t_100_ll = squeeze(cube2latlon(xc,yc,t_100(:,:,j,1:719),xi,yi));
...
name=['htrt_hist_plot_dry_l' num2str(j) '.png'];
print('-dpng',name)
...
name=['htrt_hist_plot_wet_l' num2str(j) '.png'];
print('-dpng',name)
...
name=['htrt_hist_pos_plot_wide_l' num2str(j) '.png'];
print('-dpng',name)
...
legend(dryleg, wetleg)
name=['htrt_hist_neg_plot_wide_l' num2str(j) '.png'];
print('-dpng',name)
