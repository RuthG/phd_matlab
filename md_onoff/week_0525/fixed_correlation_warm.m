...
load('/project/rg312/mat_files/vt_corr_vals_warm.mat');
...
ylabel('Pressure, hPa')
print('-dpng','vt_corr_es0_warm.png')
...
xlabel('Saturation vapour pressure fraction')
ylabel('Pressure, hPa')
print('-dpng','vt_mag_es0_warm.png')
