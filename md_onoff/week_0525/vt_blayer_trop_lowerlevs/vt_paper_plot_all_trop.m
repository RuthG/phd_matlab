...
[vNt_ed_pzints(1), vNt_ed_pzints_tneg(1), vNt_ed_pzints_tpos(1), vNt_ed_pzint_sdevs(1), vNt_ed_pzint_sdevs_tneg(1), vNt_ed_pzint_sdevs_tpos(1)] = vt_paper_plot_fun_trop('000');

'000 done'

[vNt_ed_pzints(2), vNt_ed_pzints_tneg(2), vNt_ed_pzints_tpos(2), vNt_ed_pzint_sdevs(2), vNt_ed_pzint_sdevs_tneg(2), vNt_ed_pzint_sdevs_tpos(2)] = vt_paper_plot_fun_trop('010');

'010 done'

[vNt_ed_pzints(3), vNt_ed_pzints_tneg(3), vNt_ed_pzints_tpos(3), vNt_ed_pzint_sdevs(3), vNt_ed_pzint_sdevs_tneg(3), vNt_ed_pzint_sdevs_tpos(3)] = vt_paper_plot_fun_trop('025');

'025 done'

[vNt_ed_pzints(4), vNt_ed_pzints_tneg(4), vNt_ed_pzints_tpos(4), vNt_ed_pzint_sdevs(4), vNt_ed_pzint_sdevs_tneg(4), vNt_ed_pzint_sdevs_tpos(4)] = vt_paper_plot_fun_trop('050');

'050 done'

[vNt_ed_pzints(5), vNt_ed_pzints_tneg(5), vNt_ed_pzints_tpos(5), vNt_ed_pzint_sdevs(5), vNt_ed_pzint_sdevs_tneg(5), vNt_ed_pzint_sdevs_tpos(5)] = vt_paper_plot_fun_trop('075');

'075 done'

[vNt_ed_pzints(6), vNt_ed_pzints_tneg(6), vNt_ed_pzints_tpos(6), vNt_ed_pzint_sdevs(6), vNt_ed_pzint_sdevs_tneg(6), vNt_ed_pzint_sdevs_tpos(6)] = vt_paper_plot_fun_trop('100');

'100 done'


save('/project/rg312/mat_files/vNt_paper_plot_data_trop.mat')
