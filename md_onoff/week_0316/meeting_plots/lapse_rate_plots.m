...
hold on
v = 0.1:0.1:1;
[C,h] = contour(xi,yi,front_diag_000(:,:,1)',v,'k','LineWidth',2);
caxis([-0.0013 0]);
xlim([-90 90])
ylim([0 90])
colorbar
...
hold on
v = 0.1:0.1:1;
[C,h] = contour(xi,yi,front_diag_010(:,:,1)',v,'k','LineWidth',2);
caxis([-0.0013 0]);
xlim([-90 90])
ylim([0 90])
colorbar
...
hold on
v = 0.1:0.1:1;
[C,h] = contour(xi,yi,front_diag_025(:,:,1)',v,'k','LineWidth',2);
caxis([-0.0013 0]);
xlim([-90 90])
ylim([0 90])
colorbar
...
hold on
v = 0.1:0.1:1;
[C,h] = contour(xi,yi,front_diag_050(:,:,1)',v,'k','LineWidth',2);
caxis([-0.0013 0]);
xlim([-90 90])
ylim([0 90])
colorbar
...
hold on
v = 0.1:0.1:1;
[C,h] = contour(xi,yi,front_diag_075(:,:,1)',v,'k','LineWidth',2);
caxis([-0.0013 0]);
xlim([-90 90])
ylim([0 90])
colorbar
...
hold on
v = 0.1:0.1:1;
[C,h] = contour(xi,yi,front_diag_100(:,:,1)',v,'k','LineWidth',2);
caxis([-0.0013 0]);
xlim([-90 90])
ylim([0 90])
colorbar
