...
cvdfht_ed_ll_100 = cnvht_ed_ll_100 + difht_ed_ll_100;
...
cvdfht_ed_series_100 = reshape(cvdfht_ed_ll_100(:,i,:),[numel(cvdfht_ed_ll_100(:,i,:)),1]);
...
cvdfht_ed_series_100_masked = vt_mask_100.*cvdfht_ed_series_100; 
cvdfht_ed_series_100_masked(vt_mask_100==0) = [];
...
X(:,2) = cvdfht_ed_series_100_masked;
...
title('1es0')
print('-dpng','t_cvdfht_hist3_100_masked.png')
