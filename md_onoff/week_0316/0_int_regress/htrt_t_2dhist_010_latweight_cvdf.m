...
htrt_ll_010 = squeeze(cube2latlon(xc,yc,htrt_010(:,:,5,1:719),xi,yi)).*86400;
htrt_ll_tav_010 = repmat(mean(htrt_ll_010,3),[1 1 719]);
htrt_ed_ll_010 = htrt_ll_010 - htrt_ll_tav_010;
radht_ll_010 = squeeze(cube2latlon(xc,yc,radht_010(:,:,5,1:719),xi,yi)).*86400;
radht_ll_tav_010 = repmat(mean(radht_ll_010,3),[1 1 719]);
radht_ed_ll_010 = radht_ll_010 - radht_ll_tav_010;
difht_ll_010 = squeeze(cube2latlon(xc,yc,difht_010(:,:,5,1:719),xi,yi)).*86400;
difht_ll_tav_010 = repmat(mean(difht_ll_010,3),[1 1 719]);
difht_ed_ll_010 = difht_ll_010 - difht_ll_tav_010;
cndht_ll_010 = squeeze(cube2latlon(xc,yc,cndht_010(:,:,5,1:719),xi,yi)).*86400;
cndht_ll_tav_010 = repmat(mean(cndht_ll_010,3),[1 1 719]);
cndht_ed_ll_010 = cndht_ll_010 - cndht_ll_tav_010;
cnvht_ll_010 = squeeze(cube2latlon(xc,yc,cnvht_010(:,:,5,1:719),xi,yi)).*86400;
cnvht_ll_tav_010 = repmat(mean(cnvht_ll_010,3),[1 1 719]);
cnvht_ed_ll_010 = cnvht_ll_010 - cnvht_ll_tav_010;

cvdfht_ed_ll_010 = cnvht_ed_ll_010 + difht_ed_ll_010;

t_ll_010 = squeeze(cube2latlon(xc,yc,t_010(:,:,5,1:719),xi,yi));
t_ll_tav_010 = repmat(mean(t_ll_010,3),[1 1 719]);
t_ed_ll_010 = t_ll_010 - t_ll_tav_010;

vN_ll_010 = squeeze(cube2latlon(xc,yc,vN_010(:,:,5,1:719),xi,yi));
vN_ll_tav_010 = repmat(mean(vN_ll_010,3),[1 1 719]);
...
cvdfht_ed_series_010 = reshape(cvdfht_ed_ll_010(:,i,:),[numel(cvdfht_ed_ll_010(:,i,:)),1]);
...
cvdfht_ed_series_010_masked = vt_mask_010.*cvdfht_ed_series_010; 
cvdfht_ed_series_010_masked(vt_mask_010==0) = [];
...
X(:,2) = cvdfht_ed_series_010_masked;
...
title('0.1es0')
print('-dpng','t_cvdfht_hist3_010_masked.png')
