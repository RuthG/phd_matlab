...
cvdfht_ed_ll_000 = cnvht_ed_ll_000 + difht_ed_ll_000;
...
cvdfht_ed_series_000 = reshape(cvdfht_ed_ll_000(:,i,:),[numel(cvdfht_ed_ll_000(:,i,:)),1]);
...
cvdfht_ed_series_000_masked = vt_mask_000.*cvdfht_ed_series_000; 
cvdfht_ed_series_000_masked(vt_mask_000==0) = [];
...
X(:,2) = cvdfht_ed_series_000_masked;
...
title('0es0')
print('-dpng','t_cvdfht_hist3_000_masked.png')
