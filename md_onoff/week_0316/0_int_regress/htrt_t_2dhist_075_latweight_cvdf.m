...
load('/project/rg312/mat_files/heat_rates_best.mat','htrt_075','radht_075','difht_075','cndht_075','cnvht_075')
htrt_ll_075 = squeeze(cube2latlon(xc,yc,htrt_075(:,:,5,1:719),xi,yi)).*86400;
htrt_ll_tav_075 = repmat(mean(htrt_ll_075,3),[1 1 719]);
htrt_ed_ll_075 = htrt_ll_075 - htrt_ll_tav_075;
radht_ll_075 = squeeze(cube2latlon(xc,yc,radht_075(:,:,5,1:719),xi,yi)).*86400;
radht_ll_tav_075 = repmat(mean(radht_ll_075,3),[1 1 719]);
radht_ed_ll_075 = radht_ll_075 - radht_ll_tav_075;
difht_ll_075 = squeeze(cube2latlon(xc,yc,difht_075(:,:,5,1:719),xi,yi)).*86400;
difht_ll_tav_075 = repmat(mean(difht_ll_075,3),[1 1 719]);
difht_ed_ll_075 = difht_ll_075 - difht_ll_tav_075;
cndht_ll_075 = squeeze(cube2latlon(xc,yc,cndht_075(:,:,5,1:719),xi,yi)).*86400;
cndht_ll_tav_075 = repmat(mean(cndht_ll_075,3),[1 1 719]);
cndht_ed_ll_075 = cndht_ll_075 - cndht_ll_tav_075;
cnvht_ll_075 = squeeze(cube2latlon(xc,yc,cnvht_075(:,:,5,1:719),xi,yi)).*86400;
cnvht_ll_tav_075 = repmat(mean(cnvht_ll_075,3),[1 1 719]);
cnvht_ed_ll_075 = cnvht_ll_075 - cnvht_ll_tav_075;

cvdfht_ed_ll_075 = cnvht_ed_ll_075 + difht_ed_ll_075;

t_ll_075 = squeeze(cube2latlon(xc,yc,t_075(:,:,5,1:719),xi,yi));
t_ll_tav_075 = repmat(mean(t_ll_075,3),[1 1 719]);
t_ed_ll_075 = t_ll_075 - t_ll_tav_075;

vN_ll_075 = squeeze(cube2latlon(xc,yc,vN_075(:,:,5,1:719),xi,yi));
vN_ll_tav_075 = repmat(mean(vN_ll_075,3),[1 1 719]);
...
cvdfht_ed_series_075 = reshape(cvdfht_ed_ll_075(:,i,:),[numel(cvdfht_ed_ll_075(:,i,:)),1]);
...
cvdfht_ed_series_075_masked = vt_mask_075.*cvdfht_ed_series_075; 
cvdfht_ed_series_075_masked(vt_mask_075==0) = [];
...
X(:,2) = cvdfht_ed_series_075_masked;
...
title('0.75es0')
print('-dpng','t_cvdfht_hist3_075_masked.png')
