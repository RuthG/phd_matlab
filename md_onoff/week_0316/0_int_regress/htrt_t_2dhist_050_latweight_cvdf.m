...
htrt_ll_050 = squeeze(cube2latlon(xc,yc,htrt_050(:,:,5,1:719),xi,yi)).*86400;
htrt_ll_tav_050 = repmat(mean(htrt_ll_050,3),[1 1 719]);
htrt_ed_ll_050 = htrt_ll_050 - htrt_ll_tav_050;
radht_ll_050 = squeeze(cube2latlon(xc,yc,radht_050(:,:,5,1:719),xi,yi)).*86400;
radht_ll_tav_050 = repmat(mean(radht_ll_050,3),[1 1 719]);
radht_ed_ll_050 = radht_ll_050 - radht_ll_tav_050;
difht_ll_050 = squeeze(cube2latlon(xc,yc,difht_050(:,:,5,1:719),xi,yi)).*86400;
difht_ll_tav_050 = repmat(mean(difht_ll_050,3),[1 1 719]);
difht_ed_ll_050 = difht_ll_050 - difht_ll_tav_050;
cndht_ll_050 = squeeze(cube2latlon(xc,yc,cndht_050(:,:,5,1:719),xi,yi)).*86400;
cndht_ll_tav_050 = repmat(mean(cndht_ll_050,3),[1 1 719]);
cndht_ed_ll_050 = cndht_ll_050 - cndht_ll_tav_050;
cnvht_ll_050 = squeeze(cube2latlon(xc,yc,cnvht_050(:,:,5,1:719),xi,yi)).*86400;
cnvht_ll_tav_050 = repmat(mean(cnvht_ll_050,3),[1 1 719]);
cnvht_ed_ll_050 = cnvht_ll_050 - cnvht_ll_tav_050;

cvdfht_ed_ll_050 = cnvht_ed_ll_050 + difht_ed_ll_050;

t_ll_050 = squeeze(cube2latlon(xc,yc,t_050(:,:,5,1:719),xi,yi));
t_ll_tav_050 = repmat(mean(t_ll_050,3),[1 1 719]);
t_ed_ll_050 = t_ll_050 - t_ll_tav_050;

vN_ll_050 = squeeze(cube2latlon(xc,yc,vN_050(:,:,5,1:719),xi,yi));
vN_ll_tav_050 = repmat(mean(vN_ll_050,3),[1 1 719]);
...
cvdfht_ed_series_050 = reshape(cvdfht_ed_ll_050(:,i,:),[numel(cvdfht_ed_ll_050(:,i,:)),1]);
...
cvdfht_ed_series_050_masked = vt_mask_050.*cvdfht_ed_series_050; 
cvdfht_ed_series_050_masked(vt_mask_050==0) = [];
...
X(:,2) = cvdfht_ed_series_050_masked;
...
title('0.5es0')
print('-dpng','t_cvdfht_hist3_050_masked.png')
