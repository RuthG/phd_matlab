...
[w_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,w_n,w_s,0,'/project/rg312/mat_files/front_diag_composite_data/w_000_best.mat');
[w_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,w_ed_n,w_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/w_ed_000_best.mat');
...
[t_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,t_n,t_s,0,'/project/rg312/mat_files/front_diag_composite_data/t_000_best.mat');
[t_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,t_ed_n,t_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/t_ed_000_best.mat');
...
[vN_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,vN_n,vN_s,0,'/project/rg312/mat_files/front_diag_composite_data/vN_000_best.mat');
[vN_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,vN_ed_n,vN_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/vN_ed_000_best.mat');
[vNt_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,vNt_ed_n,vNt_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/vNt_ed_000_best.mat');
...
[q_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,q_n,q_s,0,'/project/rg312/mat_files/front_diag_composite_data/q_000_best.mat');
[q_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,q_ed_n,q_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/q_ed_000_best.mat');
...
[uE_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,uE_n,uE_s,0,'/project/rg312/mat_files/front_diag_composite_data/uE_000_best.mat');
[uE_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,uE_ed_n,uE_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/uE_ed_000_best.mat');
...
[theta_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,theta_n,theta_s,0,'/project/rg312/mat_files/front_diag_composite_data/theta_000_best.mat');
[theta_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,theta_ed_n,theta_ed_s,0,'/project/rg312/mat_files/front_diag_composite_data/theta_ed_000_best.mat');
