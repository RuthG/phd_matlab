...
load('/project/rg312/mat_files/trop_levs_final.mat','trop_lev_100');
...
dcoeff_ll_n_pav = squeeze(mean(dcoeff_ll_n(:,1:trop_lev_100(xn),:),2));
dcoeff_ll_p_pav = squeeze(mean(dcoeff_ll_p(:,1:trop_lev_100(xn),:),2));
radhtth_ll_n_pav = squeeze(mean(radhtth_ll_n(:,1:trop_lev_100(xn),:),2));
radhtth_ll_p_pav = squeeze(mean(radhtth_ll_p(:,1:trop_lev_100(xn),:),2));
thth_ll_n_pav = squeeze(mean(thth_ll_n(:,1:trop_lev_100(xn),:),2));
thth_ll_p_pav = squeeze(mean(thth_ll_p(:,1:trop_lev_100(xn),:),2));
