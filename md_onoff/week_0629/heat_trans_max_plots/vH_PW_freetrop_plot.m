[vNH_ed(1,:) ,vNH_ed_warm(1,:) ,vNH_ed_cold(1,:) ,vND_ed(1,:) ,vND_ed_warm(1,:) ,vND_ed_cold(1,:)] = vH_PW_fun_freetrop('000');

[vNH_ed(2,:) ,vNH_ed_warm(2,:) ,vNH_ed_cold(2,:) ,vND_ed(2,:) ,vND_ed_warm(2,:) ,vND_ed_cold(2,:)] = vH_PW_fun_freetrop('010');

[vNH_ed(3,:) ,vNH_ed_warm(3,:) ,vNH_ed_cold(3,:) ,vND_ed(3,:) ,vND_ed_warm(3,:) ,vND_ed_cold(3,:)] = vH_PW_fun_freetrop('025');

[vNH_ed(4,:) ,vNH_ed_warm(4,:) ,vNH_ed_cold(4,:) ,vND_ed(4,:) ,vND_ed_warm(4,:) ,vND_ed_cold(4,:)] = vH_PW_fun_freetrop('050');

[vNH_ed(5,:) ,vNH_ed_warm(5,:) ,vNH_ed_cold(5,:) ,vND_ed(5,:) ,vND_ed_warm(5,:) ,vND_ed_cold(5,:)] = vH_PW_fun_freetrop('075');

[vNH_ed(6,:) ,vNH_ed_warm(6,:) ,vNH_ed_cold(6,:) ,vND_ed(6,:) ,vND_ed_warm(6,:) ,vND_ed_cold(6,:)] = vH_PW_fun_freetrop('100');
...
print('-depsc2','-r300','vH_PW_plot_freetrop.eps')
...
legend('Total','+ve T''','-ve T''','Location','northwest')
print('-depsc2','-r300','vT_PW_plot_freetrop.eps')
