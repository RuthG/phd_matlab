...
print('-dpng','w_fwhm_mag_100.png')

save('/project/rg312/mat_files/w_fwhm_mag_hist_asc.mat')
...
print('-dpng','w_fwhm_mag_wetmdry.png')
...
print('-dpng','w_fwhm_mag_wetm05.png')
...
print('-dpng','w_fwhm_mag_05mdry.png')
...
ylabel('w peak fwhm, km')
title('w Peak Strength vs FWHM, 0.5 - 0e_{s0}')
print('-dpng','w_fwhm_mag_01mdry.png')
