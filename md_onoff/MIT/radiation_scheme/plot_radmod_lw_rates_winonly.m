...
clabel(C,h);
title('1co2 win only','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('2co2 win only','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('4co2 win only','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('10co2 win only','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('20co2 win only','FontSize',12)

print('-dpdf','radmod_htrts_winonly_co2.pdf')
