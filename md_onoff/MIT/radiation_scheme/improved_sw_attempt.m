...
%del_sol_tau = ( sw_co2 + sw_wv.*q_zav(:,k) ).*0.04 ;
...
sw_wv = exp(0.01887./(tau + 0.009522) + 1.603./((tau + 0.5194).^2));
del_sol_tau = ( sw_co2 + sw_wv(:,2:26).*q_zav ).*0.04 ;
...
dtaudsigma_1co2 = (dtau - del_sol_tau)./0.04;
clear('tau','dtau')
...
dtaudsigma_2co2 = (dtau - del_sol_tau)./0.04;
clear('tau','dtau')
...
dtaudsigma_4co2 = (dtau - del_sol_tau)./0.04;
clear('tau','dtau')
...
%dtau between flux levels
for k=1:25
dtau(:,k)=tau(1:45,k+1)-tau(1:45,k);
end
dtaudsigma_10co2 = (dtau(1:45,:) - del_sol_tau(1:45,:))./0.04;
clear('tau','dtau')
...
dtaudsigma_20co2 = (dtau(1:45,:) - del_sol_tau(1:45,:))./0.04;
clear('tau','dtau')
