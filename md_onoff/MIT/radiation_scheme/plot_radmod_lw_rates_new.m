...
clabel(C,h);
title('1co2 top fit','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('2co2 top fit','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('4co2 top fit','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('10co2 top fit','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('20co2 top fit','FontSize',12)

print('-dpdf','radmod_htrts_toplevfit_co2.pdf')
...
axes('position',[pos1x pos1y xSize_sub ySize_sub])
[C,h] = contour(yi(2:45),flipud(rC)./100,tdt_win_1co2(2:45,:)',v,'k');
set(gca,'YDir','reverse','FontSize',10)
ylabel('Pressure, hPa','FontSize',12)
%xlabel('Latitude','FontSize',12)
clabel(C,h);
...
axes('position',[pos2x pos2y xSize_sub ySize_sub])
[C,h] = contour(yi(2:45),flipud(rC)./100,tdt_win_2co2(2:45,:)',v,'k');
set(gca,'YDir','reverse','FontSize',10)
%ylabel('Pressure, hPa','FontSize',12)
xlabel('Latitude','FontSize',12)
clabel(C,h);
...
axes('position',[pos3x pos3y xSize_sub ySize_sub])
[C,h] = contour(yi(2:45),flipud(rC)./100,tdt_win_4co2(2:45,:)',v,'k');
set(gca,'YDir','reverse','FontSize',10)
%ylabel('Pressure, hPa','FontSize',12)
xlabel('Latitude','FontSize',12)
clabel(C,h);
...
axes('position',[pos4x pos4y xSize_sub ySize_sub])
[C,h] = contour(yi(2:45),flipud(rC)./100,tdt_win_10co2(2:45,:)',v,'k');
set(gca,'YDir','reverse','FontSize',10)
%ylabel('Pressure, hPa','FontSize',12)
xlabel('Latitude','FontSize',12)
clabel(C,h);
...
axes('position',[pos5x pos5y xSize_sub ySize_sub])
[C,h] = contour(yi(2:45),flipud(rC)./100,tdt_win_20co2(2:45,:)',v,'k');
set(gca,'YDir','reverse','FontSize',10)
ylabel('Pressure, hPa','FontSize',12)
xlabel('Latitude','FontSize',12)
clabel(C,h);
...
print('-dpdf','radmod_htrts_toplevfit_co2_win.pdf')
...
axes('position',[pos1x pos1y xSize_sub ySize_sub])
[C,h] = contour(yi(2:45),flipud(rC)./100,tdt_lw_1co2(2:45,:)' - tdt_win_1co2(2:45,:)',v,'k');
set(gca,'YDir','reverse','FontSize',10)
ylabel('Pressure, hPa','FontSize',12)
%xlabel('Latitude','FontSize',12)
clabel(C,h);
...
axes('position',[pos2x pos2y xSize_sub ySize_sub])
[C,h] = contour(yi(2:45),flipud(rC)./100,tdt_lw_2co2(2:45,:)' - tdt_win_2co2(2:45,:)',v,'k');
set(gca,'YDir','reverse','FontSize',10)
%ylabel('Pressure, hPa','FontSize',12)
xlabel('Latitude','FontSize',12)
clabel(C,h);
...
axes('position',[pos3x pos3y xSize_sub ySize_sub])
[C,h] = contour(yi(2:45),flipud(rC)./100,tdt_lw_4co2(2:45,:)' - tdt_win_4co2(2:45,:)',v,'k');
set(gca,'YDir','reverse','FontSize',10)
%ylabel('Pressure, hPa','FontSize',12)
xlabel('Latitude','FontSize',12)
clabel(C,h);
...
axes('position',[pos4x pos4y xSize_sub ySize_sub])
[C,h] = contour(yi(2:45),flipud(rC)./100,tdt_lw_10co2(2:45,:)' - tdt_win_10co2(2:45,:)',v,'k');
set(gca,'YDir','reverse','FontSize',10)
%ylabel('Pressure, hPa','FontSize',12)
xlabel('Latitude','FontSize',12)
clabel(C,h);
...
axes('position',[pos5x pos5y xSize_sub ySize_sub])
[C,h] = contour(yi(2:45),flipud(rC)./100,tdt_lw_20co2(2:45,:)' - tdt_win_20co2(2:45,:)',v,'k');
set(gca,'YDir','reverse','FontSize',10)
ylabel('Pressure, hPa','FontSize',12)
xlabel('Latitude','FontSize',12)
clabel(C,h);
...
print('-dpdf','radmod_htrts_toplevfit_co2_nonwin.pdf')