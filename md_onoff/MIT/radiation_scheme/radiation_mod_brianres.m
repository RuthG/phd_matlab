...
load('/project/rg312/mat_files/radiation_chapter/qt_bres.mat','q_b','t_b')
...
save('/project/rg312/mat_files/radiation_chapter/heating_myscheme_bres.mat','down','down_win','up','up_win','net','net_win','solar_down','tdt_lw','tdt_sw','tdt_win','dtrans','dtrans_win','b','b_win','t_surf','b_surf')
