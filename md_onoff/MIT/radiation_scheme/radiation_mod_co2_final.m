...
sw_co2 = 0.0596 + 0.0029.*log(co2./360);
  ...
  for k= 1:n
    co2_const = 0.2023.*log(co2./360);
    co2_win_const = 0.0954.*log(co2./360); %0.1163.*log(co2./360);
...
save('/project/rg312/mat_files/radiation_chapter/heating_myscheme_10co2_final.mat','down','down_win','up','up_win','net','net_win','solar_down','tdt_lw','tdt_sw','tdt_win','dtrans','dtrans_win','b','b_win','t_surf','b_surf')
