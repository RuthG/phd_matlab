...
ylabel('TOA upward LW Flux, W/m^{2}')
legend('2co2','4co2','10co2','Location','NorthWest')
print('-dpng','toa_lw_mit_diffs.png')
...
legend('2co2','4co2','10co2','Location','NorthWest')
print('-dpng','surfdn_lw_mit_diffs.png')
...
print('-dpdf','heat_diffs_2m1co2.pdf')
...
print('-dpdf','heat_diffs_4m1co2.pdf')
...
print('-dpdf','heat_diffs_10m1co2.pdf')
