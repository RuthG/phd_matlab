...
sw_co2 = 0.0596 - 6.8190e-05.*(co2./360 - 1).^2 + 0.0013.*(co2./360 - 1);
  ...
  for k= 1:n
    co2_const = 0.5.*1.1713.*log(co2./360);
...
save('/project/rg312/mat_files/radiation_chapter/heating_myscheme_4co2_half.mat','down','down_win','up','up_win','net','net_win','solar_down','tdt_lw','tdt_sw','tdt_win','dtrans','dtrans_win','b','b_win','t_surf','b_surf')
