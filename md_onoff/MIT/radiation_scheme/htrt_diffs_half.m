...
load('/project/rg312/mat_files/radiation_chapter/heating_myscheme_2co2_half.mat')
tdt_lw_2co2 = tdt_lw;
tdt_sw_2co2 = tdt_sw;
up_lw_2co2 = up;
down_lw_2co2 = down;

load('/project/rg312/mat_files/radiation_chapter/heating_myscheme_4co2_half.mat')
tdt_lw_4co2 = tdt_lw;
tdt_sw_4co2 = tdt_sw;
up_lw_4co2 = up;
down_lw_4co2 = down;

load('/project/rg312/mat_files/radiation_chapter/heating_myscheme_10co2_half.mat')
tdt_lw_10co2 = tdt_lw;
tdt_sw_10co2 = tdt_sw;
up_lw_10co2 = up;
down_lw_10co2 = down;
...
ylabel('TOA upward LW Flux, W/m^{2}')
legend('1co2','2co2','4co2','10co2','Location','NorthWest')
print('-dpng','toa_lw_mit_half.png')
...
ylabel('TOA upward LW Flux, W/m^{2}')
legend('2co2','4co2','10co2','Location','NorthWest')
print('-dpng','toa_lw_mit_diffs_half.png')
...
ylabel('Surface upward LW Flux, W/m^{2}')
legend('1co2','2co2','4co2','10co2','Location','NorthWest')
print('-dpng','surfup_lw_mit_half.png')
...
ylabel('Surface downward LW Flux, W/m^{2}')
legend('1co2','2co2','4co2','10co2','Location','NorthWest')
print('-dpng','surfdn_lw_mit_half.png')
...
legend('2co2','4co2','10co2','Location','NorthWest')
print('-dpng','surfdn_lw_mit_diffs_half.png')
...
print('-dpdf','heat_diffs_2m1co2_half.pdf')
...
print('-dpdf','heat_diffs_4m1co2_half.pdf')
...
print('-dpdf','heat_diffs_10m1co2_half.pdf')
