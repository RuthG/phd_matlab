...
clabel(C,h);
title('1co2 first attempt','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('2co2 first attempt','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('4co2 first attempt','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('10co2 first attempt','FontSize',12)
...
xlabel('Latitude','FontSize',12)
clabel(C,h);
title('20co2 first attempt','FontSize',12)

print('-dpdf','radmod_htrts_first_co2.pdf')
