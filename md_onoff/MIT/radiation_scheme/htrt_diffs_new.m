...
ylabel('TOA upward LW Flux, W/m^{2}')
legend('2co2','4co2','10co2','Location','NorthWest')
print('-dpng','toa_lw_mit_diffs_new.png')
...
ylabel('Surface upward LW Flux, W/m^{2}')
legend('1co2','2co2','4co2','10co2','Location','NorthWest')
print('-dpng','surfup_lw_mit_new.png')
...
ylabel('Surface downward LW Flux, W/m^{2}')
legend('1co2','2co2','4co2','10co2','Location','NorthWest')
print('-dpng','surfdn_lw_mit_new.png')
...
legend('2co2','4co2','10co2','Location','NorthWest')
print('-dpng','surfdn_lw_mit_diffs_new.png')
...
print('-dpdf','heat_diffs_2m1co2_new.pdf')
...
print('-dpdf','heat_diffs_4m1co2_new.pdf')
...
print('-dpdf','heat_diffs_10m1co2_new.pdf')
