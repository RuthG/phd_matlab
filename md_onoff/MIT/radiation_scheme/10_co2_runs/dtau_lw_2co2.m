...
print('-dpdf','dtau_splitlw_10co2.pdf')
...
axes('position',[pos1x pos1y xSize_sub ySize_sub])
plot(q_in(1:45,:).*1000,(dtau_dn - dtau_dn_1co2(1:45,:))./0.04,'xk')
set(gca,'FontSize',10)
ylim([-5 5])
xlabel('Specific Humidity, g/kg','FontSize',12)
...
axes('position',[pos2x pos2y xSize_sub ySize_sub])
plot(q_in(1:45,:).*1000,(dtau_win_dn - dtau_win_dn_1co2(1:45,:))./0.04,'xk')
set(gca,'FontSize',10)
ylim([-0.25 0.25])
xlabel('Specific Humidity, g/kg','FontSize',12)
