...
save('lw_sbdart_dry.mat','fxdn_lw_l','fxup_lw_l','fxdir_lw_l','dfdz_lw_l','heat_lw_l', 'fxdn_lw_u','fxup_lw_u','fxdir_lw_u','dfdz_lw_u','heat_lw_u',  'fxdn_win','fxup_win','fxdir_win','dfdz_win','heat_win')
