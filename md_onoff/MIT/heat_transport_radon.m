...
load('/project/rg312/mat_files/snapshot_data_final/run_100_ro/vN_100_ro_5.mat')

vN_ll = squeeze(cube2latlon(xc,yc,vN_100,xi,yi));

load('/project/rg312/mat_files/snapshot_data_final/run_100_ro/t_100_ro_5.mat')
t_ll = squeeze(cube2latlon(xc,yc,t_100,xi,yi));

load('/project/rg312/mat_files/snapshot_data_final/run_100_ro/q_100_ro_5.mat')
q_ll = squeeze(cube2latlon(xc,yc,q_100,xi,yi));

load('/project/rg312/mat_files/snapshot_data_final/run_100_ro/ph_100_ro_5.mat')
...
print('-dpng','heat_trans_radon_phiapprox.png')