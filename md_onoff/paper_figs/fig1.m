...
tot_diff_sens = vNt_ed_t(6) - vNt_ed_t(1);
cold_diff_sens = vNt_ed_cold_t(6) - vNt_ed_cold_t(1);
...
totH_diff_sens = vNHph_ed(8) - vNHph_ed(1);
coldH_diff_sens = vNHph_ed_cold(8) - vNHph_ed_cold(1);
...
%print('-dpng','figure_1_ph.png')
%print('-dpdf','figure_1_ph.pdf')
%print('-depsc2','figure_1_ph.eps')
