...
vNt_ed_serr_ft = vNt_ed_serr.*sqrt(10);
vNt_ed_cold_serr_ft = vNt_ed_cold_serr.*sqrt(10);
vNt_ed_warm_serr_ft = vNt_ed_warm_serr.*sqrt(10);
...
vNt_ed_serr_t = vNt_ed_serr.*sqrt(10);
vNt_ed_cold_serr_t = vNt_ed_cold_serr.*sqrt(10);
vNt_ed_warm_serr_t = vNt_ed_warm_serr.*sqrt(10);
...
vNt_ed_serr_b = vNt_ed_serr.*sqrt(10);
vNt_ed_cold_serr_b = vNt_ed_cold_serr.*sqrt(10);
vNt_ed_warm_serr_b = vNt_ed_warm_serr.*sqrt(10);
...
fillerrors = [vNt_ed_t+2.*vNt_ed_serr_t, fliplr(vNt_ed_t-2.*vNt_ed_serr_t)];
