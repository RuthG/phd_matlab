...
clear('t_000')
t_ed_000 = t_ll_000 - repmat(t_ll_tav(:,:,5),[1 1 360]);
clear('t_ll_000')
...
clear('t_100')
t_ed_100 = t_ll_100 - repmat(t_ll_tav(:,:,5),[1 1 360]);
...
clear('vN_000')
vN_ed_000 = vN_ll_000 - repmat(vN_ll_tav(:,:,5),[1 1 360]);
clear('vN_ll_000')
...
clear('vN_100')
vN_ed_100 = vN_ll_100 - repmat(vN_ll_tav(:,:,5),[1 1 360]);
