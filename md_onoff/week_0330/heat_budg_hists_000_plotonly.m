load('/project/rg312/mat_files/heatbudg_000.mat')
...
save('/project/rg312/mat_files/heatbudg_000.mat','w_ed_dthetadp_hist','-append')
...
ylabel('Probability')
print('-dpng','total_adv_heat_hist_000.png')
