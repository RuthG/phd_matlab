...
data = load('/project/rg312/mat_files/sensitivity_data_2016/paper_vars.mat');

run={'000','010','025','050','075','100','125','150'};

for i=1:8

    load(['/project/rg312/mat_files/sensitivity_data_2016/b_lev_' char(run(i)) '.mat'])
    load(['/project/rg312/mat_files/sensitivity_data_2016/trop_lev_' char(run(i)) '.mat'])
    load(['/project/rg312/mat_files/sensitivity_data_2016/vt_lats_' char(run(i)) '.mat'])
...
es0 = [0.0,0.1,0.25,0.5,0.75,1,1.25,1.5];
cp = 287.04./(2./7.);
...
text(-0.25,2.3e4,'\fontsize{12} (b)')
%text(1.4,2.1e4,'\bf \fontsize{15} (b)')
%legend('Total','+ve T''','-ve T''','Location','northwest')

%print('-dpng','figure_1.png')
print('-dpdf','figure_1_sens.pdf')
