...
figure
[C,h]=contourf(yi,rC,htrt_t_w_000'.*86400./thsq_w_000',[-20,-2:0.2:0]);
...
figure
h=contourf(yi,rC,htrt_t_c_000'.*86400./thsq_c_000',[-20,-2:0.2:0]);
%set(h,'edgecolor','none')
hold on
grid on
plot([yi(x000n),yi(x000n)],[0,980],'k--', 'LineWidth',2)
...
figure
h=contourf(yi,rC,htrt_t_w_100'.*86400./thsq_w_100',[-20,-2:0.2:0]);
%set(h,'edgecolor','none')
hold on
grid on
...
figure
h=contourf(yi,rC,htrt_t_c_100'.*86400./thsq_c_100',[-20,-2:0.2:0]);
%set(h,'edgecolor','none')
hold on
grid on
plot([yi(x100n),yi(x100n)],[0,980],'k--', 'LineWidth',2)
