...
figure
plot(yi(46:90),N_mean_000(46:90))
hold on
plot(yi(46:90),N_mean_010(46:90),'g')
plot(yi(46:90),N_mean_025(46:90),'r')
plot(yi(46:90),N_mean_050(46:90),'m')
plot(yi(46:90),N_mean_075(46:90),'c')
plot(yi(46:90),N_mean_100(46:90),'k')
plot(yi(46:90),N_mean_th(46:90),'m--')
legend('0es0','0.1es0','0.25es0','0.5es0','0.75es0','1.0es0','tropheat')
xlabel('Latitude')
ylabel('Buoyancy frequency, s^{-1}')
title('Buoyancy Frequency')
print('-dpng','N.png')

figure
plot(yi(46:90),trop_000(46:90))
hold on
plot(yi(46:90),trop_010(46:90),'g')
plot(yi(46:90),trop_025(46:90),'r')
plot(yi(46:90),trop_050(46:90),'m')
plot(yi(46:90),trop_075(46:90),'c')
plot(yi(46:90),trop_100(46:90),'k')
plot(yi(46:90),trop_th(46:90),'m--')
legend('0es0','0.1es0','0.25es0','0.5es0','0.75es0','1.0es0','tropheat')
xlabel('Latitude')
ylabel('Tropopause height, m')
title('Tropopause Height')
print('-dpng','tropopause_height.png')

figure
plot(yi(46:90),f(46:90).*radius.*cos(yi(46:90).*pi./180))
xlabel('Latitude')
ylabel('f a cos(\theta)')
title('Geometric factors')
print('-dpng','geometry_rossby.png')
