...
q_th_n = q_th_ll(:,xthn-7:xthn+7,:,:);

q_th_s = q_th_ll(:,xths-7:xths+7,:,:);


%clear large matrices
clear('q_th_ll','q_th')

[comp_q_th_m2,check0] = composite_fun_timelag(peaks_th,vt_thresh_th,q_th_n,q_th_s,-2,'/project/rg312/mat_files/composite_data_tlag/q_compdata_thm2.mat');
[comp_q_th_m1,check0] = composite_fun_timelag(peaks_th,vt_thresh_th,q_th_n,q_th_s,-1,'/project/rg312/mat_files/composite_data_tlag/q_compdata_thm1.mat');
[comp_q_th_0,check0] = composite_fun_timelag(peaks_th,vt_thresh_th,q_th_n,q_th_s,0,'/project/rg312/mat_files/composite_data_tlag/q_compdata_th.mat');
[comp_q_th_p1,check0] = composite_fun_timelag(peaks_th,vt_thresh_th,q_th_n,q_th_s,1,'/project/rg312/mat_files/composite_data_tlag/q_compdata_thp1.mat');
[comp_q_th_p2,check0] = composite_fun_timelag(peaks_th,vt_thresh_th,q_th_n,q_th_s,2,'/project/rg312/mat_files/composite_data_tlag/q_compdata_thp2.mat');
...
print('-dpng','../q_tlag_plots/q_th_m2.png')
hold off
...
print('-dpng','../q_tlag_plots/q_th_m1.png')
hold off
...
print('-dpng','../q_tlag_plots/q_th_0.png')
hold off
...
ylabel('Pressure, hPa','FontSize',15)
title('q composite, 0.5es0, tropical heating, lag 1','FontSize',15)
print('-dpng','../q_tlag_plots/q_th_p1.png')
hold off
...
ylabel('Pressure, hPa','FontSize',15)
title('q composite, 0.5es0, tropical heating, lag 2','FontSize',15)
print('-dpng','../q_tlag_plots/q_th_p2.png')
hold off
