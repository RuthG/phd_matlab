...
load('/project/rg312/mat_files/composite_data_ss/qed_compdata_000.mat')
comp_q_ed_000 = nanmean(comp_data,3);
load('/project/rg312/mat_files/composite_data_ss/qed_compdata_010.mat')
comp_q_ed_010 = nanmean(comp_data,3);
load('/project/rg312/mat_files/composite_data_ss/qed_compdata_025.mat')
comp_q_ed_025 = nanmean(comp_data,3);
load('/project/rg312/mat_files/composite_data_ss/qed_compdata_050.mat')
comp_q_ed_050 = nanmean(comp_data,3);
load('/project/rg312/mat_files/composite_data_ss/qed_compdata_075.mat')
comp_q_ed_075 = nanmean(comp_data,3);
load('/project/rg312/mat_files/composite_data_ss/qed_compdata_100.mat')
...
load('/project/rg312/mat_files/composite_data_ss/thed_compdata_000.mat')
comp_th_ed_000 = nanmean(comp_data,3);
load('/project/rg312/mat_files/composite_data_ss/thed_compdata_010.mat')
comp_th_ed_010 = nanmean(comp_data,3);
load('/project/rg312/mat_files/composite_data_ss/thed_compdata_025.mat')
comp_th_ed_025 = nanmean(comp_data,3);
load('/project/rg312/mat_files/composite_data_ss/thed_compdata_050.mat')
comp_th_ed_050 = nanmean(comp_data,3);
load('/project/rg312/mat_files/composite_data_ss/thed_compdata_075.mat')
comp_th_ed_075 = nanmean(comp_data,3);
load('/project/rg312/mat_files/composite_data_ss/thed_compdata_100.mat')
