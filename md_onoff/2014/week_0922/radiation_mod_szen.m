...
solar_tau(:,1) = 0.;
mag_fac = 35.0./sqrt(1224.*cos(szen).^2 +1);
...
save('radmod_sw_szen_mag.mat','solar_down','flux_sw','tdt_sw','solar_tau','dtrans_sol') 

save('radmod_lw_szen_mag.mat','down','down_win','up','up_win','net','tdt_lw','dtrans','dtrans_win')
