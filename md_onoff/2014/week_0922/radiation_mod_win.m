...
window = -0.0963.*t_in.^2./100./100 + 0.6496.*t_in./100 -0.7066;
window_surf = -0.0963.*t_surf.^2./100./100 + 0.6496.*t_surf./100 -0.7066;
...
save('radmod_sw_win.mat','solar_down','flux_sw','tdt_sw','solar_tau','dtrans_sol') 

save('radmod_lw_win.mat','down','down_win','up','up_win','net','net_win','tdt_lw','tdt_win','dtrans','dtrans_win','b','b_win','q_in','t_in','t_surf','b_surf')
