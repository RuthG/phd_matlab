...
Grid='C';
ny=90;
load('/disk1/MITgcm/verification/atm_gray_ruth/md_onoff/means_monththirteen.mat')
wet=true;
...
[uE_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(uE,ny,yc,ar,hc);
[vN_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(vN,ny,yc,ar,hc);
[theta_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(theta,ny,yc,ar,hc);
[temp_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(temp,ny,yc,ar,hc);
[uv_ed_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(uv_ed,ny,yc,ar,hc);
[vt_ed_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(vt_ed,ny,yc,ar,hc);
[w_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(w,ny,yc,ar,hc);
[q_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(q,ny,yc,ar,hc);
[htrt_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(htrt_theta,ny,yc,ar,hc);
[radht_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(radht_theta,ny,yc,ar,hc);
[cndht_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(cndht_theta,ny,yc,ar,hc);
[cnvht_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(cnvht_theta,ny,yc,ar,hc);
[difht_zav_lt,mskzon,ylat,areazon]=calcZonalAvgCube(difht_theta,ny,yc,ar,hc);
...
uE_hzav_lt(46-i,:) = (uE_zav_lt(i,:) + uE_zav_lt(91-i,:))./2;

vN_hzav_lt(46-i,:) = (-1*vN_zav_lt(i,:) + vN_zav_lt(91-i,:))./2;

theta_hzav_lt(46-i,:) = (theta_zav_lt(i,:) + theta_zav_lt(91-i,:))./2;

temp_hzav_lt(46-i,:) = (temp_zav_lt(i,:) + temp_zav_lt(91-i,:))./2;

uv_ed_hzav_lt(46-i,:) = (-1*uv_ed_zav_lt(i,:) + uv_ed_zav_lt(91-i,:))./2;

vt_ed_hzav_lt(46-i,:) = (-1*vt_ed_zav_lt(i,:) + vt_ed_zav_lt(91-i,:))./2;

w_hzav_lt(46-i,:) = (w_zav_lt(i,:) + w_zav_lt(91-i,:))./2;

q_hzav_lt(46-i,:) = (q_zav_lt(i,:) + q_zav_lt(91-i,:))./2;

htrt_hzav_lt(46-i,:) = (htrt_zav_lt(i,:) + htrt_zav_lt(91-i,:))./2;

radht_hzav_lt(46-i,:) = (radht_zav_lt(i,:) + radht_zav_lt(91-i,:))./2;

cndht_hzav_lt(46-i,:) = (cndht_zav_lt(i,:) + cndht_zav_lt(91-i,:))./2;

cnvht_hzav_lt(46-i,:) = (cnvht_zav_lt(i,:) + cnvht_zav_lt(91-i,:))./2;

difht_hzav_lt(46-i,:) = (difht_zav_lt(i,:) + difht_zav_lt(91-i,:))./2;

end

for i=1

uE_diffs(:,:,i) = uE_hzav_lt(:,:,i) - uE_hzav_c;
vN_diffs(:,:,i) = vN_hzav_lt(:,:,i) - vN_hzav_c;
theta_diffs(:,:,i) = theta_hzav_lt(:,:,i) - theta_hzav_c;
temp_diffs(:,:,i) = temp_hzav_lt(:,:,i) - temp_hzav_c;
uv_ed_diffs(:,:,i) = uv_ed_hzav_lt(:,:,i) - uv_ed_hzav_c;
vt_ed_diffs(:,:,i) = vt_ed_hzav_lt(:,:,i) - vt_ed_hzav_c;
w_diffs(:,:,i) = w_hzav_lt(:,:,i) - w_hzav_c;
q_diffs(:,:,i) = q_hzav_lt(:,:,i) - q_hzav_c;
htrt_diffs(:,:,i) = htrt_hzav_lt(:,:,i) - htrt_hzav_c;
radht_diffs(:,:,i) = radht_hzav_lt(:,:,i) - radht_hzav_c;
cndht_diffs(:,:,i) = cndht_hzav_lt(:,:,i) - cndht_hzav_c;
cnvht_diffs(:,:,i) = cnvht_hzav_lt(:,:,i) - cnvht_hzav_c;
difht_diffs(:,:,i) = difht_hzav_lt(:,:,i) - difht_hzav_c;
...
freezeColors
cbfreeze(colorbar);
name=['best_lastten' num2str(i) '.ps'];
