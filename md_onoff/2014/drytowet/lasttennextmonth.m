...
save('means_lasttennm.mat', 'uE', 'vN', 'theta', ...
'temp', 'uv_ed', 'vt_ed', 'w', 'q', 'htrt_theta', ... 
'radht_theta', 'cndht_theta', 'cnvht_theta', 'difht_theta');
...
save('means_lasttennm_hzav.mat', 'uE_hzav', 'vN_hzav', 'theta_hzav', ...
