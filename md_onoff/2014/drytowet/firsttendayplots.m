...
[uE_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(uE_firstten,ny,yc,ar,hc);
[vN_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(vN_firstten,ny,yc,ar,hc);
[theta_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(theta_firstten,ny,yc,ar,hc);
[temp_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(temp_firstten,ny,yc,ar,hc);
[uv_ed_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(uv_ed_firstten,ny,yc,ar,hc);
[vt_ed_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(vt_ed_firstten,ny,yc,ar,hc);
[w_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(w_firstten,ny,yc,ar,hc);
[q_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(q_firstten,ny,yc,ar,hc);
[htrt_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(htrt_firstten,ny,yc,ar,hc);
[radht_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(radht_firstten,ny,yc,ar,hc);
[cndht_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(cndht_firstten,ny,yc,ar,hc);
[cnvht_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(cnvht_firstten,ny,yc,ar,hc);
[difht_zav_ft,mskzon,ylat,areazon]=calcZonalAvgCube(difht_firstten,ny,yc,ar,hc);
...
uE_hzav_ft(46-i,:,:) = (uE_zav_ft(i,:,:) + uE_zav_ft(91-i,:,:))./2;

vN_hzav_ft(46-i,:,:) = (-1*vN_zav_ft(i,:,:) + vN_zav_ft(91-i,:,:))./2;

theta_hzav_ft(46-i,:,:) = (theta_zav_ft(i,:,:) + theta_zav_ft(91-i,:,:))./2;

temp_hzav_ft(46-i,:,:) = (temp_zav_ft(i,:,:) + temp_zav_ft(91-i,:,:))./2;

uv_ed_hzav_ft(46-i,:,:) = (-1*uv_ed_zav_ft(i,:,:) + uv_ed_zav_ft(91-i,:,:))./2;

vt_ed_hzav_ft(46-i,:,:) = (-1*vt_ed_zav_ft(i,:,:) + vt_ed_zav_ft(91-i,:,:))./2;

w_hzav_ft(46-i,:,:) = (w_zav_ft(i,:,:) + w_zav_ft(91-i,:,:))./2;

q_hzav_ft(46-i,:,:) = (q_zav_ft(i,:,:) + q_zav_ft(91-i,:,:))./2;

htrt_hzav_ft(46-i,:,:) = (htrt_zav_ft(i,:,:) + htrt_zav_ft(91-i,:,:))./2;

radht_hzav_ft(46-i,:,:) = (radht_zav_ft(i,:,:) + radht_zav_ft(91-i,:,:))./2;

cndht_hzav_ft(46-i,:,:) = (cndht_zav_ft(i,:,:) + cndht_zav_ft(91-i,:,:))./2;

cnvht_hzav_ft(46-i,:,:) = (cnvht_zav_ft(i,:,:) + cnvht_zav_ft(91-i,:,:))./2;

difht_hzav_ft(46-i,:,:) = (difht_zav_ft(i,:,:) + difht_zav_ft(91-i,:,:))./2;

end

for i=1:10

uE_diffs(:,:,i) = uE_hzav_ft(:,:,i) - uE_hzav_c;
vN_diffs(:,:,i) = vN_hzav_ft(:,:,i) - vN_hzav_c;
theta_diffs(:,:,i) = theta_hzav_ft(:,:,i) - theta_hzav_c;
temp_diffs(:,:,i) = temp_hzav_ft(:,:,i) - temp_hzav_c;
uv_ed_diffs(:,:,i) = uv_ed_hzav_ft(:,:,i) - uv_ed_hzav_c;
vt_ed_diffs(:,:,i) = vt_ed_hzav_ft(:,:,i) - vt_ed_hzav_c;
w_diffs(:,:,i) = w_hzav_ft(:,:,i) - w_hzav_c;
q_diffs(:,:,i) = q_hzav_ft(:,:,i) - q_hzav_c;
htrt_diffs(:,:,i) = htrt_hzav_ft(:,:,i) - htrt_hzav_c;
radht_diffs(:,:,i) = radht_hzav_ft(:,:,i) - radht_hzav_c;
cndht_diffs(:,:,i) = cndht_hzav_ft(:,:,i) - cndht_hzav_c;
cnvht_diffs(:,:,i) = cnvht_hzav_ft(:,:,i) - cnvht_hzav_c;
difht_diffs(:,:,i) = difht_hzav_ft(:,:,i) - difht_hzav_c;
