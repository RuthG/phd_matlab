...
w_24hr = w;
q_24hr = q;
htrt_24hr = htrt_theta;
radht_24hr = radht_theta;
cndht_24hr = cndht_theta;
cnvht_24hr = cnvht_theta;
difht_24hr = difht_theta;

save('means_first24hr.mat', 'uE_24hr', 'vN_24hr', 'theta_24hr', ...
'temp_24hr', 'uv_ed_24hr', 'vt_ed_24hr', 'w_24hr', 'q_24hr', 'htrt_24hr', ... 
'radht_24hr', 'cndht_24hr', 'cnvht_24hr', 'difht_24hr');

%take zonal averages for plots

[uE_zav,mskzon,ylat,areazon]=calcZonalAvgCube(uE_24hr,ny,yc,ar,hc);
[vN_zav,mskzon,ylat,areazon]=calcZonalAvgCube(vN_24hr,ny,yc,ar,hc);
[theta_zav,mskzon,ylat,areazon]=calcZonalAvgCube(theta_24hr,ny,yc,ar,hc);
[temp_zav,mskzon,ylat,areazon]=calcZonalAvgCube(temp_24hr,ny,yc,ar,hc);
[uv_ed_zav,mskzon,ylat,areazon]=calcZonalAvgCube(uv_ed_24hr,ny,yc,ar,hc);
[vt_ed_zav,mskzon,ylat,areazon]=calcZonalAvgCube(vt_ed_24hr,ny,yc,ar,hc);
[w_zav,mskzon,ylat,areazon]=calcZonalAvgCube(w_24hr,ny,yc,ar,hc);
[q_zav,mskzon,ylat,areazon]=calcZonalAvgCube(q_24hr,ny,yc,ar,hc);
[htrt_zav,mskzon,ylat,areazon]=calcZonalAvgCube(htrt_24hr,ny,yc,ar,hc);
[radht_zav,mskzon,ylat,areazon]=calcZonalAvgCube(radht_24hr,ny,yc,ar,hc);
[cndht_zav,mskzon,ylat,areazon]=calcZonalAvgCube(cndht_24hr,ny,yc,ar,hc);
[cnvht_zav,mskzon,ylat,areazon]=calcZonalAvgCube(cnvht_24hr,ny,yc,ar,hc);
[difht_zav,mskzon,ylat,areazon]=calcZonalAvgCube(difht_24hr,ny,yc,ar,hc);
...
save('means_hours_hzav.mat', 'uE_hzav', 'vN_hzav', 'theta_hzav', ...
