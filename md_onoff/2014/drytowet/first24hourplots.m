%load in hour avs from wet to dry expt and plot up
...
Grid='C';
ny=90;
load('/disk1/MITgcm/verification/atm_gray_ruth/md_onoff/means_first24hr.mat')
wet=true;
...
[uE_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(uE_24hr,ny,yc,ar,hc);
[vN_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(vN_24hr,ny,yc,ar,hc);
[theta_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(theta_24hr,ny,yc,ar,hc);
[temp_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(temp_24hr,ny,yc,ar,hc);
[uv_ed_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(uv_ed_24hr,ny,yc,ar,hc);
[vt_ed_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(vt_ed_24hr,ny,yc,ar,hc);
[w_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(w_24hr,ny,yc,ar,hc);
[q_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(q_24hr,ny,yc,ar,hc);
[htrt_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(htrt_24hr,ny,yc,ar,hc);
[radht_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(radht_24hr,ny,yc,ar,hc);
[cndht_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(cndht_24hr,ny,yc,ar,hc);
[cnvht_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(cnvht_24hr,ny,yc,ar,hc);
[difht_zav_ftf,mskzon,ylat,areazon]=calcZonalAvgCube(difht_24hr,ny,yc,ar,hc);
...
uE_hzav_ftf(46-i,:,:) = (uE_zav_ftf(i,:,:) + uE_zav_ftf(91-i,:,:))./2;

vN_hzav_ftf(46-i,:,:) = (-1*vN_zav_ftf(i,:,:) + vN_zav_ftf(91-i,:,:))./2;

theta_hzav_ftf(46-i,:,:) = (theta_zav_ftf(i,:,:) + theta_zav_ftf(91-i,:,:))./2;

temp_hzav_ftf(46-i,:,:) = (temp_zav_ftf(i,:,:) + temp_zav_ftf(91-i,:,:))./2;

uv_ed_hzav_ftf(46-i,:,:) = (-1*uv_ed_zav_ftf(i,:,:) + uv_ed_zav_ftf(91-i,:,:))./2;

vt_ed_hzav_ftf(46-i,:,:) = (-1*vt_ed_zav_ftf(i,:,:) + vt_ed_zav_ftf(91-i,:,:))./2;

w_hzav_ftf(46-i,:,:) = (w_zav_ftf(i,:,:) + w_zav_ftf(91-i,:,:))./2;

q_hzav_ftf(46-i,:,:) = (q_zav_ftf(i,:,:) + q_zav_ftf(91-i,:,:))./2;

htrt_hzav_ftf(46-i,:,:) = (htrt_zav_ftf(i,:,:) + htrt_zav_ftf(91-i,:,:))./2;

radht_hzav_ftf(46-i,:,:) = (radht_zav_ftf(i,:,:) + radht_zav_ftf(91-i,:,:))./2;

cndht_hzav_ftf(46-i,:,:) = (cndht_zav_ftf(i,:,:) + cndht_zav_ftf(91-i,:,:))./2;

cnvht_hzav_ftf(46-i,:,:) = (cnvht_zav_ftf(i,:,:) + cnvht_zav_ftf(91-i,:,:))./2;

difht_hzav_ftf(46-i,:,:) = (difht_zav_ftf(i,:,:) + difht_zav_ftf(91-i,:,:))./2;

end

for i=1:10

uE_diffs(:,:,i) = uE_hzav_ftf(:,:,i) - uE_hzav_c;
vN_diffs(:,:,i) = vN_hzav_ftf(:,:,i) - vN_hzav_c;
theta_diffs(:,:,i) = theta_hzav_ftf(:,:,i) - theta_hzav_c;
temp_diffs(:,:,i) = temp_hzav_ftf(:,:,i) - temp_hzav_c;
uv_ed_diffs(:,:,i) = uv_ed_hzav_ftf(:,:,i) - uv_ed_hzav_c;
vt_ed_diffs(:,:,i) = vt_ed_hzav_ftf(:,:,i) - vt_ed_hzav_c;
w_diffs(:,:,i) = w_hzav_ftf(:,:,i) - w_hzav_c;
q_diffs(:,:,i) = q_hzav_ftf(:,:,i) - q_hzav_c;
htrt_diffs(:,:,i) = htrt_hzav_ftf(:,:,i) - htrt_hzav_c;
radht_diffs(:,:,i) = radht_hzav_ftf(:,:,i) - radht_hzav_c;
cndht_diffs(:,:,i) = cndht_hzav_ftf(:,:,i) - cndht_hzav_c;
cnvht_diffs(:,:,i) = cnvht_hzav_ftf(:,:,i) - cnvht_hzav_c;
difht_diffs(:,:,i) = difht_hzav_ftf(:,:,i) - difht_hzav_c;
