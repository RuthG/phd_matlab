...
a=system('find vsquareem_data.mat');
...
save('vsquareem_data.mat')

else

load('vsquareem_data.mat')
...
ke_ed_int = reshape(sum(ke_ed_horiz_int,2),24,1).*4000;

plot(13:36,ke_ed_int)
ylabel('Global integral of eddy KE, Pam^4/s^2')
xlabel('Time, months')
print('-dpng','ke_eddy_em.png')
