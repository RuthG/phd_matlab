...
ny=90;
ylat = -89:2:89;
load('/disk1/MITgcm/verification/atm_gray_ruth/md_onoff/drytowet_tidy/tdayav_data.mat')

load('/disk1/MITgcm/verification/atm_gray_ruth/md_onoff/drytowet_tidy/ctrl_data.mat')

for i=1:36

uE_diffs(:,:,i) = uE_td_hzav(:,:,i) - uE_cl_hzav;
vN_diffs(:,:,i) = vN_td_hzav(:,:,i) - vN_cl_hzav;
theta_diffs(:,:,i) = theta_td_hzav(:,:,i) - theta_cl_hzav;
temp_diffs(:,:,i) = temp_td_hzav(:,:,i) - temp_cl_hzav;
uv_ed_diffs(:,:,i) = uv_ed_td_hzav(:,:,i) - uv_ed_cl_hzav;
vt_ed_diffs(:,:,i) = vt_ed_td_hzav(:,:,i) - vt_ed_cl_hzav;
w_diffs(:,:,i) = w_td_hzav(:,:,i) - w_cl_hzav;
q_diffs(:,:,i) = q_td_hzav(:,:,i) - q_cl_hzav;
htrt_diffs(:,:,i) = htrt_td_hzav(:,:,i) - htrt_cl_hzav;
radht_diffs(:,:,i) = radht_td_hzav(:,:,i) - radht_cl_hzav;
cndht_diffs(:,:,i) = cndht_td_hzav(:,:,i) - cndht_cl_hzav;
cnvht_diffs(:,:,i) = cnvht_td_hzav(:,:,i) - cnvht_cl_hzav;
difht_diffs(:,:,i) = difht_td_hzav(:,:,i) - difht_cl_hzav;
...
freezeColors
cbfreeze(colorbar);
name=['best_tendayav' num2str(i) '.ps'];
