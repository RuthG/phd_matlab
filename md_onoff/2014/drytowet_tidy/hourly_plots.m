...
ny=90;
ylat = -89:2:89;
load('/disk1/MITgcm/verification/atm_gray_ruth/md_onoff/drytowet_tidy/hourly_data.mat')

load('/disk1/MITgcm/verification/atm_gray_ruth/md_onoff/drytowet_tidy/ctrl_data.mat')

for i=1:10

uE_diffs(:,:,i) = uE_hr_hzav(:,:,i) - uE_cl_hzav;
vN_diffs(:,:,i) = vN_hr_hzav(:,:,i) - vN_cl_hzav;
theta_diffs(:,:,i) = theta_hr_hzav(:,:,i) - theta_cl_hzav;
temp_diffs(:,:,i) = temp_hr_hzav(:,:,i) - temp_cl_hzav;
uv_ed_diffs(:,:,i) = uv_ed_hr_hzav(:,:,i) - uv_ed_cl_hzav;
vt_ed_diffs(:,:,i) = vt_ed_hr_hzav(:,:,i) - vt_ed_cl_hzav;
w_diffs(:,:,i) = w_hr_hzav(:,:,i) - w_cl_hzav;
q_diffs(:,:,i) = q_hr_hzav(:,:,i) - q_cl_hzav;
htrt_diffs(:,:,i) = htrt_hr_hzav(:,:,i) - htrt_cl_hzav;
radht_diffs(:,:,i) = radht_hr_hzav(:,:,i) - radht_cl_hzav;
cndht_diffs(:,:,i) = cndht_hr_hzav(:,:,i) - cndht_cl_hzav;
cnvht_diffs(:,:,i) = cnvht_hr_hzav(:,:,i) - cnvht_cl_hzav;
difht_diffs(:,:,i) = difht_hr_hzav(:,:,i) - difht_cl_hzav;
