...
uE_diffs(:,:,i) = uE_ft_hzav(:,:,i) - uE_cl_hzav;
vN_diffs(:,:,i) = vN_ft_hzav(:,:,i) - vN_cl_hzav;
theta_diffs(:,:,i) = theta_ft_hzav(:,:,i) - theta_cl_hzav;
temp_diffs(:,:,i) = temp_ft_hzav(:,:,i) - temp_cl_hzav;
uv_ed_diffs(:,:,i) = uv_ed_ft_hzav(:,:,i) - uv_ed_cl_hzav;
vt_ed_diffs(:,:,i) = vt_ed_ft_hzav(:,:,i) - vt_ed_cl_hzav;
w_diffs(:,:,i) = w_ft_hzav(:,:,i) - w_cl_hzav;
q_diffs(:,:,i) = q_ft_hzav(:,:,i) - q_cl_hzav;
htrt_diffs(:,:,i) = htrt_ft_hzav(:,:,i) - htrt_cl_hzav;
radht_diffs(:,:,i) = radht_ft_hzav(:,:,i) - radht_cl_hzav;
cndht_diffs(:,:,i) = cndht_ft_hzav(:,:,i) - cndht_cl_hzav;
cnvht_diffs(:,:,i) = cnvht_ft_hzav(:,:,i) - cnvht_cl_hzav;
difht_diffs(:,:,i) = difht_ft_hzav(:,:,i) - difht_cl_hzav;
...
freezeColors
cbfreeze(colorbar);
name=['best_firstten' num2str(i) '.ps'];
