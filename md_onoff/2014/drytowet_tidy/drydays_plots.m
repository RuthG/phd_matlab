...
ny=90;
ylat = -89:2:89;
load('/disk1/MITgcm/verification/atm_gray_ruth/md_onoff/drytowet_tidy/drydays_data.mat')

load('/disk1/MITgcm/verification/atm_gray_ruth/md_onoff/drytowet_tidy/ctrl_data.mat')

for i=1:10

uE_diffs(:,:,i) = uE_dd_hzav(:,:,i) - uE_cl_hzav;
vN_diffs(:,:,i) = vN_dd_hzav(:,:,i) - vN_cl_hzav;
theta_diffs(:,:,i) = theta_dd_hzav(:,:,i) - theta_cl_hzav;
temp_diffs(:,:,i) = temp_dd_hzav(:,:,i) - temp_cl_hzav;
uv_ed_diffs(:,:,i) = uv_ed_dd_hzav(:,:,i) - uv_ed_cl_hzav;
vt_ed_diffs(:,:,i) = vt_ed_dd_hzav(:,:,i) - vt_ed_cl_hzav;
w_diffs(:,:,i) = w_dd_hzav(:,:,i) - w_cl_hzav;
q_diffs(:,:,i) = q_dd_hzav(:,:,i) - q_cl_hzav;
htrt_diffs(:,:,i) = htrt_dd_hzav(:,:,i) - htrt_cl_hzav;
radht_diffs(:,:,i) = radht_dd_hzav(:,:,i) - radht_cl_hzav;
cndht_diffs(:,:,i) = cndht_dd_hzav(:,:,i) - cndht_cl_hzav;
cnvht_diffs(:,:,i) = cnvht_dd_hzav(:,:,i) - cnvht_cl_hzav;
difht_diffs(:,:,i) = difht_dd_hzav(:,:,i) - difht_cl_hzav;
...
freezeColors
cbfreeze(colorbar);
name=['best_drydays' num2str(i) '.ps'];
