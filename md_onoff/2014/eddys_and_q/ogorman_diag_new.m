...
a=system('find eke_new_data.mat');
...
save('eke_new_data.mat')

else

load('eke_new_data.mat')
...
[ke_q_zav,mskzon,ylat,areazon]=calcZonalAvgCube(ke_q,ny,yc,ar,hc);
...
eke_q_jm2 = 0.5.*4000/9.81 .* sum(eke_q_tzav,2);
...
eke_diag_q = (mean(eke_q_jm2(max_no_q(1):min_no_q(1))) + mean(eke_q_jm2(min_no_q(2):max_no_q(2))))./2;
