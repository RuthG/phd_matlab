...
ir_tau_pole 	= 1.5;
linear_tau 	= 0.1;
ir_tau_co2 	= 0.0603./0.04; %0.154925; 
ir_tau_wv 	= 12.2050./0.04; %351.48; 
...
save('radmod_sw_np.mat','solar_down','flux_sw','tdt_sw','solar_tau','dtrans_sol') 

save('radmod_lw_np.mat','down','down_win','up','up_win','net','net_win','tdt_lw','tdt_win','dtrans','dtrans_win','b','b_win','q_in','t_in','t_surf','b_surf')
