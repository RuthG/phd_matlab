...
ir_tau_pole 	= 1.5;
linear_tau 	= 0.1;
ir_tau_co2 	= 0.1162./0.04;    %0.154925; 
ir_tau_wv 	= 129.018./0.04;  %351.48; 
...
if wv_exponent == 0.
  for k= 1:n
    del_tau = (ir_tau_co2 + ir_tau_wv.*q_in(:,k)).*(p_half(k+1) - p_half(k))./p_half(n+1);
...
save('radmod_sw_4.mat','solar_down','flux_sw','tdt_sw','solar_tau','dtrans_sol') 

save('radmod_lw_4.mat','down','down_win','up','up_win','net','net_win','tdt_lw','tdt_win','dtrans','dtrans_win','b','b_win','q_in','t_in','t_surf','b_surf')
