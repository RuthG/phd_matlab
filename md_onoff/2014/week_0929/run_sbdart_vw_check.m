%run sbdart for two q profiles from new run output, one at equator one at higher lat.
%compare with heating rates produced by mitgcm run, and by running matlab radiation mod for vw, np, and original schemes.
