...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,1)'-uE_tav_c(:,:,1)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,1)'-uE_tav_c(:,:,1)',v,'k:');
colorbar;
colormap(b2r(-5,5));
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,2)'-uE_tav_c(:,:,2)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,2)'-uE_tav_c(:,:,2)',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,3)'-uE_tav_c(:,:,3)',v);
hold on
v=-1000:1000:1000;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,3)'-uE_tav_c(:,:,3)',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,4)'-uE_tav_c(:,:,4)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,4)'-uE_tav_c(:,:,4)',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,5)'-uE_tav_c(:,:,5)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,5)'-uE_tav_c(:,:,5)',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,6)'-uE_tav_c(:,:,6)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,6)'-uE_tav_c(:,:,6)',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
axes('position',[pos1x pos1y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,1)'-vN_tav_c(:,:,1)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,1)'-vN_tav_c(:,:,1)',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
axes('position',[pos2x pos2y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,2)'-vN_tav_c(:,:,2)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,2)'-vN_tav_c(:,:,2)',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
...
axes('position',[pos3x pos3y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,3)'-vN_tav_c(:,:,3)',v);
hold on
v=-1000:1000:1000;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,3)'-vN_tav_c(:,:,3)',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
axes('position',[pos4x pos4y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,4)'-vN_tav_c(:,:,4)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,4)'-vN_tav_c(:,:,4)',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
...
axes('position',[pos5x pos5y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,5)'-vN_tav_c(:,:,5)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,5)'-vN_tav_c(:,:,5)',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
axes('position',[pos6x pos6y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,6)'-vN_tav_c(:,:,6)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,6)'-vN_tav_c(:,:,6)',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
axes('position',[pos1x pos1y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,1)'-temp_tav_c(:,:,1)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,1)'-temp_tav_c(:,:,1)',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
axes('position',[pos2x pos2y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,2)'-temp_tav_c(:,:,2)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,2)'-temp_tav_c(:,:,2)',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
...
axes('position',[pos3x pos3y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,3)'-temp_tav_c(:,:,3)',v);
hold on
v=-1000:1000:1000;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,3)'-temp_tav_c(:,:,3)',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
axes('position',[pos4x pos4y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,4)'-temp_tav_c(:,:,4)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,4)'-temp_tav_c(:,:,4)',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
...
axes('position',[pos5x pos5y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,5)'-temp_tav_c(:,:,5)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,5)'-temp_tav_c(:,:,5)',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
axes('position',[pos6x pos6y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,6)'-temp_tav_c(:,:,6)',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,6)'-temp_tav_c(:,:,6)',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
quiver(ylat,rC./10^3,1e-14.*(Fphi_scaled_tav(:,:,1)' - Fphi_scaled_tav_c(:,:,1)') ,1.6e-20.*(Fp_scaled_tav(:,:,1)' -  Fp_scaled_tav_c(:,:,1)') ,'k','AutoScale','off');
set(gca,'YDir','reverse')
xlim([-90 90])
...
axes('position',[pos2x pos2y xSize_sub ySize_sub])
labelling = num2str(shiftdim([10000:10000:100000],1));
quiver(ylat,rC./10^3,1e-14.*(Fphi_scaled_tav(:,:,2)' - Fphi_scaled_tav_c(:,:,2)') ,1.6e-20.*(Fp_scaled_tav(:,:,2)' -  Fp_scaled_tav_c(:,:,2)') ,'k','AutoScale','off');
set(gca,'YDir','reverse')
xlim([-90 90])
ylim([rC(25)./10^3 rC(1)./10^3])
set(gca,'YTickLabel',labelling)
...
axes('position',[pos3x pos3y xSize_sub ySize_sub])
labelling = num2str(shiftdim([10000:10000:100000],1));
quiver(ylat,rC./10^3,1e-14.*(Fphi_scaled_tav(:,:,3)' - Fphi_scaled_tav_c(:,:,3)') ,1.6e-20.*(Fp_scaled_tav(:,:,3)' -  Fp_scaled_tav_c(:,:,3)') ,'k','AutoScale','off');
set(gca,'YDir','reverse')
xlim([-90 90])
ylim([rC(25)./10^3 rC(1)./10^3])
set(gca,'YTickLabel',labelling)
...
axes('position',[pos4x pos4y xSize_sub ySize_sub])
labelling = num2str(shiftdim([10000:10000:100000],1));
quiver(ylat,rC./10^3,1e-14.*(Fphi_scaled_tav(:,:,4)' - Fphi_scaled_tav_c(:,:,4)') ,1.6e-20.*(Fp_scaled_tav(:,:,4)' -  Fp_scaled_tav_c(:,:,4)') ,'k','AutoScale','off');
set(gca,'YDir','reverse')
xlim([-90 90])
ylim([rC(25)./10^3 rC(1)./10^3])
set(gca,'YTickLabel',labelling)
...
axes('position',[pos5x pos5y xSize_sub ySize_sub])
labelling = num2str(shiftdim([10000:10000:100000],1));
quiver(ylat,rC./10^3,1e-14.*(Fphi_scaled_tav(:,:,5)' - Fphi_scaled_tav_c(:,:,5)') ,1.6e-20.*(Fp_scaled_tav(:,:,5)' -  Fp_scaled_tav_c(:,:,5)') ,'k','AutoScale','off');
set(gca,'YDir','reverse')
xlim([-90 90])
ylim([rC(25)./10^3 rC(1)./10^3])
set(gca,'YTickLabel',labelling)
...
axes('position',[pos6x pos6y xSize_sub ySize_sub])
labelling = num2str(shiftdim([10000:10000:100000],1));
quiver(ylat,rC./10^3,1e-14.*(Fphi_scaled_tav(:,:,6)' - Fphi_scaled_tav_c(:,:,6)') ,1.6e-20.*(Fp_scaled_tav(:,:,6)' -  Fp_scaled_tav_c(:,:,6)') ,'k','AutoScale','off');
set(gca,'YDir','reverse')
xlim([-90 90])
ylim([rC(25)./10^3 rC(1)./10^3])
set(gca,'YTickLabel',labelling)
