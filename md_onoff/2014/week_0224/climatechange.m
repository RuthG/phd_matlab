...
theta_tav_c = mean(theta_zav_c,3);
temp_tav_c = mean(temp_zav_c,3);
uE_tav_c = mean(uE_zav_c,3);
vN_tav_c = mean(vN_zav_c,3);
w_tav_c = mean(w_zav_c,3);
Fphi_scaled_tav_c = mean(Fphi_scaled_c,3);
Fp_scaled_tav_c = mean(Fp_scaled_c,3);
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,1)'-uE_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,1)'-uE_tav_c',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,2)'-uE_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,2)'-uE_tav_c',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,3)'-uE_tav_c',v);
hold on
v=-1000:1000:1000;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,3)'-uE_tav_c',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,4)'-uE_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,4)'-uE_tav_c',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,5)'-uE_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,5)'-uE_tav_c',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
v=-5:0.5:5;
[C,h]=contourf(ylat,rC./100.,uE_tav(:,:,6)'-uE_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,uE_tav(:,:,6)'-uE_tav_c',v,'k:');
colorbar;
colormap(b2r(-5,5));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
axes('position',[pos1x pos1y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,1)'-vN_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,1)'-vN_tav_c',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
axes('position',[pos2x pos2y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,2)'-vN_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,2)'-vN_tav_c',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
...
axes('position',[pos3x pos3y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,3)'-vN_tav_c',v);
hold on
v=-1000:1000:1000;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,3)'-vN_tav_c',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
axes('position',[pos4x pos4y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,4)'-vN_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,4)'-vN_tav_c',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
...
axes('position',[pos5x pos5y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,5)'-vN_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,5)'-vN_tav_c',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
axes('position',[pos6x pos6y xSize_sub ySize_sub])
v=-1:0.2:1;
[C,h]=contourf(ylat,rC./100.,vN_tav(:,:,6)'-vN_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,vN_tav(:,:,6)'-vN_tav_c',v,'k:');
colorbar;
colormap(b2r(-1,1));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
axes('position',[pos1x pos1y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,1)'-temp_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,1)'-temp_tav_c',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
axes('position',[pos2x pos2y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,2)'-temp_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,2)'-temp_tav_c',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
...
axes('position',[pos3x pos3y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,3)'-temp_tav_c',v);
hold on
v=-1000:1000:1000;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,3)'-temp_tav_c',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
...
axes('position',[pos4x pos4y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,4)'-temp_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,4)'-temp_tav_c',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
...
axes('position',[pos5x pos5y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,5)'-temp_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,5)'-temp_tav_c',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
xlabel('Latitude')
...
axes('position',[pos6x pos6y xSize_sub ySize_sub])
v=-3:0.2:2;
[C,h]=contourf(ylat,rC./100.,temp_tav(:,:,6)'-temp_tav_c',v);
hold on
v=-300:300:300;
[C,h]=contour(ylat,rC./100.,temp_tav(:,:,6)'-temp_tav_c',v,'k:');
colorbar;
colormap(b2r(-3,2));
set(gca,'YDir','reverse')
xlabel('Latitude')
