...
dtempdy_bvav = mean(dtempdy_bzav(3:level));

a_mape = prefac.*sigma_diff.*merid_width.^2.*gamma_vav.*dtempdy_bvav.^2;

name = ['approxmape_' dir_label '.mat'];
save(name)
