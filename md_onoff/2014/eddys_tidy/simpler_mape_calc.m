...
dthetadz_bzav = (mean(dthetadz(max_no(1):min_no(1),:),1) + mean(dthetadz(min_no(2):max_no(2),:),1))./2;
dthetadp_bzav = (mean(dthetadp(max_no(1):min_no(1),:),1) + mean(dthetadp(min_no(2):max_no(2),:),1))./2;
dthetady_bzav = (mean(-dthetady(max_no(1):min_no(1),:),1) + mean(dthetady(min_no(2):max_no(2),:),1))./2;
...
integral = sum(integrand).*4000.*merid_width.^2.;
