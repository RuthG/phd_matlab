...
command = ['mv OUTPUT sw_output_files_bt/OUTPUT_wv_' int2str(i)]
	system(command)
...
command = ['mv OUTPUT lw_output_files_bt/OUTPUT_wv_l_' int2str(i)]
	system(command)
...
command = ['mv OUTPUT lw_output_files_bt/OUTPUT_wv_u_' int2str(i)]
	system(command)
...
command = ['mv OUTPUT win_output_files_bt/OUTPUT_wv_' int2str(i)]
	system(command)
