...
system('rm OUTPUT')
command = ['cp ./atm_profs_tdiff/atms.dat_' int2str(i) ' atms.dat']
...
%command = ['mv OUTPUT sw_output_files_tdiff/OUTPUT_wv_' int2str(i)]
%	system(command)
...
%command = ['mv OUTPUT lw_output_files_tdiff/OUTPUT_wv_l_' int2str(i)]
%	system(command)
...
%command = ['mv OUTPUT lw_output_files_tdiff/OUTPUT_wv_u_' int2str(i)]
%	system(command)
...
command = ['mv OUTPUT win_output_files_tdiff/OUTPUT_wv_' int2str(i)]
	system(command)
