...
vt_ed_diff = vt_ed_w_ezav - vt_ed_c_ezav;
...
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,vt_ed_w_shad(:,:,i)',v);
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,uE_w_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,psi_w_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,theta_w_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,htrt_w_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,eke_w_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
%v=[0,1];
%[C,h]=contourf(ylat(46:90),rC./10^3.,Fp_w_shad(:,:,i)',v);
%set(h,'edgecolor','none') 
%colormap(flipud(gray)) ;
%caxis([0 5])
%hold on
