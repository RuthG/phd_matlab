...
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,qgref_th_shad(:,:,i)',v);
...
print('-dpdf','qgref_only_tropheat3.pdf')
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,fluxdiv_th_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
print('-dpdf','fluxdiff_ens_tropheat3.pdf')
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,Fp_th_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
print('-dpdf','Fp_ens_tropheat3.pdf')
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,Fphi_th_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
print('-dpdf','Fphi_ens_tropheat3.pdf')
