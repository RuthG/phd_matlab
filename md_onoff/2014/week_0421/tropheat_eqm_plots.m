...
psi_diff = psi_th_yzav - psi_c_yzav;
uE_diff = uE_th_yzav - uE_c_yzav;
theta_diff = theta_th_yzav - theta_c_yzav;
htrt_diff = htrt_th_yzav - htrt_c_yzav;
...
eke_diff = eke_th_yzav - eke_c_yzav;
qgref_diff = masking.*(qgref_th_yzav - qgref_c_yzav);
vt_ed_diff = vt_ed_th_yzav - vt_ed_c_yzav;

figure
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,vt_ed_th_shad_y',v);
...
ylabel('Pressure, hPa')
hold off
print('-dpdf','vt_tropheat3_eqm.pdf')
return


figure
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,uE_th_shad_y',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
ylabel('Pressure, hPa')
hold off
print('-dpdf','u_tropheat3_eqm.pdf')

figure
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,psi_th_shad_y',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
ylabel('Pressure, hPa')
hold off
print('-dpdf','psi_tropheat3_eqm.pdf')

figure
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,theta_th_shad_y',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
ylabel('Pressure, hPa')
hold off
print('-dpdf','theta_tropheat3_eqm.pdf')

figure
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,htrt_th_shad_y',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
ylabel('Pressure, hPa')
hold off
print('-dpdf','htrt_tropheat3_eqm.pdf')
...
hold off
print('-dpdf','qgref_tropheat3_eqm.pdf')

figure
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,eke_th_shad_y',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
ylabel('Pressure, hPa')
hold off
print('-dpdf','eke_tropheat3_eqm.pdf')
...
text(69, 12, '\fontsize{8}5E20 M3(PA)');
hold off
print('-dpdf','epflux_tropheat3_eqm.pdf')
