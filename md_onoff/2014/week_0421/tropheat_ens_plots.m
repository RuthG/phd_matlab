...
for i=1:6
masking_load(find(qgref_th_ezav(:,:,i) >= 0 & qgref_c_ezav(:,:,i) >=0 )) = 1;
masking(:,:,i) = masking_load;
end


psi_diff = psi_th_ezav - psi_c_ezav;
uE_diff = uE_th_ezav - uE_c_ezav;
theta_diff = theta_th_ezav - theta_c_ezav;
htrt_diff = htrt_th_ezav - htrt_c_ezav;
Fphi_diff = Fphi_scaled_th_ezav - Fphi_scaled_c_ezav;
Fp_diff = Fp_scaled_th_ezav - Fp_scaled_c_ezav;
fluxdiv_diff = fluxdiv_th_ezav - fluxdiv_c_ezav;
eke_diff = eke_th_ezav - eke_c_ezav;
qgref_diff = masking.*(qgref_th_ezav - qgref_c_ezav);
vt_ed_diff = vt_ed_th_ezav - vt_ed_c_ezav;
...
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,vt_ed_th_shad(:,:,i)',v);
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,uE_th_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,psi_th_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,theta_th_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
print('-dpdf','theta_tropheat3.pdf')
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,htrt_th_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
print('-dpdf','qgref_tropheat3.pdf')
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./100.,eke_th_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
axes('position',[posx(i) posy(i) xSize_sub ySize_sub])
v=[0,1];
[C,h]=contourf(ylat(46:90),rC./10^3.,Fp_th_shad(:,:,i)',v);
set(h,'edgecolor','none') 
colormap(flipud(gray)) ;
caxis([0 5])
hold on
...
print('-dpdf','epflux_tropheat3.pdf')
