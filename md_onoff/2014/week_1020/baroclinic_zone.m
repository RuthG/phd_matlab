...
tke_01 = (tzav(:,:,4,1) + tzav(:,:,5,1))./2;
tke_75 = (tzav(:,:,4,2) + tzav(:,:,5,2))./2;
tke_10 = (tzav(:,:,4,3) + tzav(:,:,5,3))./2;


convthetatoT=(rC/101325.0).^(2./7.);
for j=1:size(rC)
t_01(:,j)=tzav(:,j,2,1).*convthetatoT(j,1);
t_75(:,j)=tzav(:,j,2,2).*convthetatoT(j,1);
t_10(:,j)=tzav(:,j,2,3).*convthetatoT(j,1);
