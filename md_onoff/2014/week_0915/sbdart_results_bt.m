...
print('-dpdf','sw_flux_trans_bt.pdf')
...
axes('position',[pos3x pos3y xSize_sub ySize_sub])
v=-4:0.2:0.2;
[C,h] = contour(yi(2:89),p(2:25),(heat_lw(2:89,2:25)'+heat_win(2:89,2:25)'),v,'k');
clabel(C,h);
set(gca,'YDir','reverse')
ylabel('Pressure, hPa')
xlabel('Latitude')
