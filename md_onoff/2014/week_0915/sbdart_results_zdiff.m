...
load('lw_sbdart_zdiff.mat')
load('sw_sbdart_zdiff.mat')
load('radmod_sw.mat')
load('radmod_lw.mat')
...
print('-dpdf','sw_flux_trans_zdiff.pdf')
...
print('-dpdf','lw_fluxes_zdiff.pdf')
...
print('-dpdf','lw_fluxwin_zdiff.pdf')
...
print('-dpdf','heatrates_zdiff.pdf')
