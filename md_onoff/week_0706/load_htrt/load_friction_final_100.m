...
for j=1:10
i=0
dudt_100 = zeros(192,32,25,360);
dvdt_100 = zeros(192,32,25,360);
...
name=['/project/rg312/mat_files/snapshot_data_final/run_100/duEdt_100_' num2str(j) '.mat'];
save(name,'duEdt_100')

name=['/project/rg312/mat_files/snapshot_data_final/run_100/dvNdt_100_' num2str(j) '.mat'];
save(name,'dvNdt_100')
