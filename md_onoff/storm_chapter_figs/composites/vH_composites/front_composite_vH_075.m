...
clear('vN_ll_075','vN_ll_tav_075','vN_ed_ll_075')
...
[vNH_comp,check0] = composite_fun_timelag(peaks_075,fd_thresh_075,vNH_ed_n,vNH_ed_s,0,['/project/rg312/mat_files/storm_chapter_data/run_075/vNH_075_comp_' num2str(year) '.mat']);
