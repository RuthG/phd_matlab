...
clear('vN_ll_025','vN_ll_tav_025','vN_ed_ll_025')
...
[vNH_comp,check0] = composite_fun_timelag(peaks_025,fd_thresh_025,vNH_ed_n,vNH_ed_s,0,['/project/rg312/mat_files/storm_chapter_data/run_025/vNH_025_comp_' num2str(year) '.mat']);
