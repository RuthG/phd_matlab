...
clear('vN_ll_150','vN_ll_tav_150','vN_ed_ll_150')
...
[vNH_comp,check0] = composite_fun_timelag(peaks_150,fd_thresh_150,vNH_ed_n,vNH_ed_s,0,['/project/rg312/mat_files/storm_chapter_data/run_150/vNH_150_comp_' num2str(year) '.mat']);
