%load arnaud diag and vNs for 075 run and start thinking about how to handle composite
...
load(['/project/rg312/mat_files/snapshot_data_final/run_075/t_075_' num2str(year) '.mat'],'t_075')
load(['/project/rg312/mat_files/snapshot_data_final/run_075/t_075_timemean.mat'])
t_ll_075 = cube2latlon(xc,yc,t_075,xi,yi);
t_ll_tav_075 = repmat(mean(t_ll_tav,4),[1 1 1 360]);
t_ed_ll_075 = t_ll_075 - t_ll_tav_075;
t_ed_n = t_ed_ll_075(:,x075n-7:x075n+7,:,:);
t_ed_s = t_ed_ll_075(:,x075s-7:x075s+7,:,:);
clear('t_ll_075','t_ll_tav_075','t_ed_ll_075')

load(['/project/rg312/mat_files/snapshot_data_final/run_075/q_075_' num2str(year) '.mat'],'q_075')
load(['/project/rg312/mat_files/snapshot_data_final/run_075/q_075_timemean.mat'])
q_ll_075 = cube2latlon(xc,yc,q_075,xi,yi);
q_ll_tav_075 = repmat(mean(q_ll_tav,4),[1 1 1 360]);
...
load(['/project/rg312/mat_files/snapshot_data_final/run_075/ph_adj_075_' num2str(year) '.mat'],'ph_adj_075')
load(['/project/rg312/mat_files/snapshot_data_final/run_075/ph_adj_075_timemean.mat'])
ph_adj_ll_075 = cube2latlon(xc,yc,ph_adj_075,xi,yi);
ph_adj_ll_tav_075 = repmat(mean(ph_adj_ll_tav,4),[1 1 1 360]);
ph_adj_ed_ll_075 = ph_adj_ll_075 - ph_adj_ll_tav_075;
ph_adj_ed_n = ph_adj_ed_ll_075(:,x075n-7:x075n+7,:,:);
ph_adj_ed_s = ph_adj_ed_ll_075(:,x075s-7:x075s+7,:,:);
clear('ph_adj_ll_075','ph_adj_ll_tav_075','ph_adj_ed_ll_075')

H_ed_n = t_ed_n.*cp + q_ed_n.*L + ph_adj_ed_n;
H_ed_s = t_ed_s.*cp + q_ed_s.*L + ph_adj_ed_s;


[H_comp,check0] = composite_fun_timelag(peaks_075,fd_thresh_075,H_ed_n,H_ed_s,0,['/project/rg312/mat_files/storm_chapter_data/run_075/H_075_comp_' num2str(year) '.mat']);
