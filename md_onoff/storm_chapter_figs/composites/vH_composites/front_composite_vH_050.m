...
clear('vN_ll_050','vN_ll_tav_050','vN_ed_ll_050')
...
[vNH_comp,check0] = composite_fun_timelag(peaks_050,fd_thresh_050,vNH_ed_n,vNH_ed_s,0,['/project/rg312/mat_files/storm_chapter_data/run_050/vNH_050_comp_' num2str(year) '.mat']);
