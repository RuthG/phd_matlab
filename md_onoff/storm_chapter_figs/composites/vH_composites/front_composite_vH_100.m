...
clear('vN_ll_100','vN_ll_tav_100','vN_ed_ll_100')
...
[vNH_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,vNH_ed_n,vNH_ed_s,0,['/project/rg312/mat_files/storm_chapter_data/run_100/vNH_100_comp_' num2str(year) '.mat']);
