...
[vNH_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,vNH_ed_n,vNH_ed_s,0,['/project/rg312/mat_files/storm_chapter_data/run_000/vNH_000_comp_' num2str(year) '.mat']);
