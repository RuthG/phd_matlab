...
load(['/project/rg312/mat_files/snapshot_data_final/run_075/htrt_075_' num2str(year) '.mat'],'htrt_075')
htrt_ll_075 = cube2latlon(xc,yc,htrt_075,xi,yi).*86400;
htrt_n = htrt_ll_075(:,x075n-7:x075n+7,:,:);
htrt_s = htrt_ll_075(:,x075s-7:x075s+7,:,:);
clear('htrt_ll_075')
[htrt_comp,check0] = composite_fun_timelag(peaks_075,fd_thresh_075,htrt_n,htrt_s,0,['/project/rg312/mat_files/storm_chapter_data/run_075/htrt_075_comp_' num2str(year) '.mat']);
x=-34:2:34;
