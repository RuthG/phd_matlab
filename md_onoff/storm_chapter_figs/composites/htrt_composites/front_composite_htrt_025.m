...
load(['/project/rg312/mat_files/snapshot_data_final/run_025/htrt_025_' num2str(year) '.mat'],'htrt_025')
htrt_ll_025 = cube2latlon(xc,yc,htrt_025,xi,yi).*86400;
htrt_n = htrt_ll_025(:,x025n-7:x025n+7,:,:);
htrt_s = htrt_ll_025(:,x025s-7:x025s+7,:,:);
clear('htrt_ll_025')
[htrt_comp,check0] = composite_fun_timelag(peaks_025,fd_thresh_025,htrt_n,htrt_s,0,['/project/rg312/mat_files/storm_chapter_data/run_025/htrt_025_comp_' num2str(year) '.mat']);
x=-34:2:34;
