...
load(['/project/rg312/mat_files/snapshot_data_final/run_050/htrt_050_' num2str(year) '.mat'],'htrt_050')
htrt_ll_050 = cube2latlon(xc,yc,htrt_050,xi,yi).*86400;
htrt_n = htrt_ll_050(:,x050n-7:x050n+7,:,:);
htrt_s = htrt_ll_050(:,x050s-7:x050s+7,:,:);
clear('htrt_ll_050')
[htrt_comp,check0] = composite_fun_timelag(peaks_050,fd_thresh_050,htrt_n,htrt_s,0,['/project/rg312/mat_files/storm_chapter_data/run_050/htrt_050_comp_' num2str(year) '.mat']);
x=-34:2:34;
