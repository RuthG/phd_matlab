...
load(['/project/rg312/mat_files/snapshot_data_final/run_125/htrt_125_' num2str(year) '.mat'],'htrt_125')
htrt_ll_125 = cube2latlon(xc,yc,htrt_125,xi,yi).*86400;
htrt_n = htrt_ll_125(:,x125n-7:x125n+7,:,:);
htrt_s = htrt_ll_125(:,x125s-7:x125s+7,:,:);
clear('htrt_ll_125')
[htrt_comp,check0] = composite_fun_timelag(peaks_125,fd_thresh_125,htrt_n,htrt_s,0,['/project/rg312/mat_files/storm_chapter_data/run_125/htrt_125_comp_' num2str(year) '.mat']);
x=-34:2:34;
