...
load(['/project/rg312/mat_files/snapshot_data_final/run_th/htrt_th_' num2str(year) '.mat'],'htrt_th')
htrt_ll_th = cube2latlon(xc,yc,htrt_th,xi,yi).*86400;
htrt_n = htrt_ll_th(:,xthn-7:xthn+7,:,:);
htrt_s = htrt_ll_th(:,xths-7:xths+7,:,:);
clear('htrt_ll_th')
[htrt_comp,check0] = composite_fun_timelag(peaks_th,fd_thresh_th,htrt_n,htrt_s,0,['/project/rg312/mat_files/storm_chapter_data/run_th/htrt_th_comp_' num2str(year) '.mat']);
x=-34:2:34;
