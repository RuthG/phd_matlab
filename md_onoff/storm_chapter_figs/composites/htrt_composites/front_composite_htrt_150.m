...
load(['/project/rg312/mat_files/snapshot_data_final/run_150/htrt_150_' num2str(year) '.mat'],'htrt_150')
htrt_ll_150 = cube2latlon(xc,yc,htrt_150,xi,yi).*86400;
htrt_n = htrt_ll_150(:,x150n-7:x150n+7,:,:);
htrt_s = htrt_ll_150(:,x150s-7:x150s+7,:,:);
clear('htrt_ll_150')
[htrt_comp,check0] = composite_fun_timelag(peaks_150,fd_thresh_150,htrt_n,htrt_s,0,['/project/rg312/mat_files/storm_chapter_data/run_150/htrt_150_comp_' num2str(year) '.mat']);
x=-34:2:34;
