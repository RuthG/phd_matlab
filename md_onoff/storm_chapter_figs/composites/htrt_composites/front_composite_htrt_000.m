...
load(['/project/rg312/mat_files/snapshot_data_final/run_000_ns/htrt_000_' num2str(year) '.mat'],'htrt_000')
...
[htrt_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,htrt_n,htrt_s,0,['/project/rg312/mat_files/storm_chapter_data/run_000/htrt_000_comp_' num2str(year) '.mat']);
x=-34:2:34;
