...
load(['/project/rg312/mat_files/snapshot_data_final/run_100/htrt_100_' num2str(year) '.mat'],'htrt_100')
htrt_ll_100 = cube2latlon(xc,yc,htrt_100,xi,yi).*86400;
htrt_ll_tav_100 = repmat(mean(htrt_ll_100,4),[1 1 1 360]);
...
[htrt_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,htrt_ed_n,htrt_ed_s,0,['/project/rg312/mat_files/storm_chapter_data/run_100/htrt_100_comp_' num2str(year) '.mat']);
x=-34:2:34;
