...
v_n = vN_ll_150(:,x150n-7:x150n+7,:,:);
v_s = -1.*vN_ll_150(:,x150s-7:x150s+7,:,:);
clear('vN_ll_150')
[vN_comp,check0] = composite_fun_timelag(peaks_150,fd_thresh_150,v_n,v_s,0,['/project/rg312/mat_files/storm_chapter_data/run_150/vN_150_comp_' num2str(year) '.mat']);
