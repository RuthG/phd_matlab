...
clear('t_ll_000','t_ed_ll_000')
[t_ed_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,t_ed_n,t_ed_s,0,['/project/rg312/mat_files/storm_chapter_data/run_000/t_ed_000_comp_' num2str(year) '.mat']);
