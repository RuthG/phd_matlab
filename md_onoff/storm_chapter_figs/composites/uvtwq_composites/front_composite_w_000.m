...
load(['/project/rg312/mat_files/snapshot_data_final/run_000_ns/w_000_' num2str(year) '.mat'],'w_000')
w_ll_000 = cube2latlon(xc,yc,w_000,xi,yi);
w_n = w_ll_000(:,x000n-7:x000n+7,:,:);
w_s = w_ll_000(:,x000s-7:x000s+7,:,:);
clear('w_ll_000')
[w_comp,check0] = composite_fun_timelag(peaks_000,fd_thresh_000,w_n,w_s,0,['/project/rg312/mat_files/storm_chapter_data/run_000/w_000_comp_' num2str(year) '.mat']);
