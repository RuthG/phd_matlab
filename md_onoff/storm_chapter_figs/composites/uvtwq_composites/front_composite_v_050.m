...
v_n = vN_ll_050(:,x050n-7:x050n+7,:,:);
v_s = -1.*vN_ll_050(:,x050s-7:x050s+7,:,:);
clear('vN_ll_050')
[vN_comp,check0] = composite_fun_timelag(peaks_050,fd_thresh_050,v_n,v_s,0,['/project/rg312/mat_files/storm_chapter_data/run_050/vN_050_comp_' num2str(year) '.mat']);
