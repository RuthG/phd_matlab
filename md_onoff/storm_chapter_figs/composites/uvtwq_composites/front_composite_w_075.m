...
load(['/project/rg312/mat_files/snapshot_data_final/run_075/w_075_' num2str(year) '.mat'],'w_075')
w_ll_075 = cube2latlon(xc,yc,w_075,xi,yi);
w_n = w_ll_075(:,x075n-7:x075n+7,:,:);
w_s = w_ll_075(:,x075s-7:x075s+7,:,:);
clear('w_ll_075')
[w_comp,check0] = composite_fun_timelag(peaks_075,fd_thresh_075,w_n,w_s,0,['/project/rg312/mat_files/storm_chapter_data/run_075/w_075_comp_' num2str(year) '.mat']);
