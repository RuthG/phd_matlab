...
for i=1:15
ved_n(:,i,:,:) = vN_ed_ll_125(:,x125n-8+i,:,:).*cot( yi(x125n - 8 + i).*pi./180 )./radius;
ved_s(:,i,:,:) = vN_ed_ll_125(:,x125s-8+i,:,:).*cot( yi(x125s - 8 + i).*pi./180 )./radius;;
end

clear('vN_ll_125','vN_ed_ll_125')
[wsv_comp,check0] = composite_fun_timelag(peaks_125,fd_thresh_125,ved_n,ved_s,0,['/project/rg312/mat_files/storm_chapter_data/run_125/wsv_125_comp_' num2str(year) '.mat']);
