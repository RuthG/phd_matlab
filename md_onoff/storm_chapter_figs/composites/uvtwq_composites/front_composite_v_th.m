...
v_n = vN_ll_th(:,xthn-7:xthn+7,:,:);
v_s = -1.*vN_ll_th(:,xths-7:xths+7,:,:);
clear('vN_ll_th')
[vN_comp,check0] = composite_fun_timelag(peaks_th,fd_thresh_th,v_n,v_s,0,['/project/rg312/mat_files/storm_chapter_data/run_th/vN_th_comp_' num2str(year) '.mat']);
