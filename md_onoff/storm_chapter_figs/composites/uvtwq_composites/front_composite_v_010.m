...
v_n = vN_ll_010(:,x010n-7:x010n+7,:,:);
v_s = -1.*vN_ll_010(:,x010s-7:x010s+7,:,:);
clear('vN_ll_010')
[vN_comp,check0] = composite_fun_timelag(peaks_010,fd_thresh_010,v_n,v_s,0,['/project/rg312/mat_files/storm_chapter_data/run_010/vN_010_comp_' num2str(year) '.mat']);
