...
load(['/project/rg312/mat_files/snapshot_data_final/run_125/w_125_' num2str(year) '.mat'],'w_125')
w_ll_125 = cube2latlon(xc,yc,w_125,xi,yi);
w_n = w_ll_125(:,x125n-7:x125n+7,:,:);
w_s = w_ll_125(:,x125s-7:x125s+7,:,:);
clear('w_ll_125')
[w_comp,check0] = composite_fun_timelag(peaks_125,fd_thresh_125,w_n,w_s,0,['/project/rg312/mat_files/storm_chapter_data/run_125/w_125_comp_' num2str(year) '.mat']);
