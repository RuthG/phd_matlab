...
load(['/project/rg312/mat_files/snapshot_data_final/run_025/w_025_' num2str(year) '.mat'],'w_025')
w_ll_025 = cube2latlon(xc,yc,w_025,xi,yi);
w_n = w_ll_025(:,x025n-7:x025n+7,:,:);
w_s = w_ll_025(:,x025s-7:x025s+7,:,:);
clear('w_ll_025')
[w_comp,check0] = composite_fun_timelag(peaks_025,fd_thresh_025,w_n,w_s,0,['/project/rg312/mat_files/storm_chapter_data/run_025/w_025_comp_' num2str(year) '.mat']);
