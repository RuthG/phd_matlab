...
load(['/project/rg312/mat_files/snapshot_data_final/run_100/w_100_' num2str(year) '.mat'],'w_100')
w_ll_100 = cube2latlon(xc,yc,w_100,xi,yi);
w_n = w_ll_100(:,x100n-7:x100n+7,:,:);
w_s = w_ll_100(:,x100s-7:x100s+7,:,:);
clear('w_ll_100')
[w_comp,check0] = composite_fun_timelag(peaks_100,fd_thresh_100,w_n,w_s,0,['/project/rg312/mat_files/storm_chapter_data/run_100/w_100_comp_' num2str(year) '.mat']);
