...
vv_ed_pzav(:,:,year) = squeeze(mean(mean(vv_ed(:,:,1:tlev(xn),:),1),3));
vv_ed_warm_pzav(:,:,year) = squeeze(mean(mean(vv_ed_warm(:,:,1:tlev(xn),:),1),3));
vv_ed_cold_pzav(:,:,year) = squeeze(mean(mean(vv_ed_cold(:,:,1:tlev(xn),:),1),3));
