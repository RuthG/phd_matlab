...
vNH_ed_pzav(:,:,year) = squeeze(mean(mean(vNH_ed(:,:,1:blev(xn),:),1),3));
vNH_ed_warm_pzav(:,:,year) = squeeze(mean(mean(vNH_ed_warm(:,:,1:blev(xn),:),1),3));
vNH_ed_cold_pzav(:,:,year) = squeeze(mean(mean(vNH_ed_cold(:,:,1:blev(xn),:),1),3));
