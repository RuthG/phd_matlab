...
output_lw1 = dlmread('~/matlab/radscheme_checks/out/OUTPUT_lw1');
output_lw2 = dlmread('~/matlab/radscheme_checks/out/OUTPUT_lw2');
output_lw3 = dlmread('~/matlab/radscheme_checks/out/OUTPUT_lw3');
output_lw4 = dlmread('~/matlab/radscheme_checks/out/OUTPUT_lw4');
output_lw5 = dlmread('~/matlab/radscheme_checks/out/OUTPUT_lw5');
output_lw6 = dlmread('~/matlab/radscheme_checks/out/OUTPUT_lw6');
...
fxdn_lw(:,1)  = output_lw1(2:26,3);
fxdn_lw(:,2)  = output_lw2(2:26,3);
fxdn_lw(:,3)  = output_lw3(2:26,3);
fxdn_lw(:,4)  = output_lw4(2:26,3);
fxdn_lw(:,5)  = output_lw5(2:26,3);
fxdn_lw(:,6)  = output_lw6(2:26,3);
fxup_lw(:,1)  = output_lw1(2:26,4);
fxup_lw(:,2)  = output_lw2(2:26,4);
fxup_lw(:,3)  = output_lw3(2:26,4);
fxup_lw(:,4)  = output_lw4(2:26,4);
fxup_lw(:,5)  = output_lw5(2:26,4);
fxup_lw(:,6)  = output_lw6(2:26,4);
heat_lw(:,1)  = output_lw1(2:26,7);
heat_lw(:,2)  = output_lw2(2:26,7);
heat_lw(:,3)  = output_lw3(2:26,7);
heat_lw(:,4)  = output_lw4(2:26,7);
heat_lw(:,5)  = output_lw5(2:26,7);
heat_lw(:,6)  = output_lw6(2:26,7);
...
subplot(2,3,1)
plot(heat_lw(2:25,1),p_half(2:25))
hold on
