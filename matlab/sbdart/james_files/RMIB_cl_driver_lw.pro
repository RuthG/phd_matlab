...
; RMIB: cloud, longwave
; edited by James Ingram 17/01/2013

; interactive: requires input from user where appropriate

pro RMIB_cl_driver_lw
...
spawn, "ln -s F:/PHD/SBDART/ERA_interim_data/atmos_201006051200.dat atms.dat"
