load('/disk1/MITgcm/verification/atm_gray_ruth/wv_off_rad_off/run_5year_c/ep_flux.mat'); %matlab_diags/ep_flux_ctrl.mat')

Fp_scaled_ctrl = Fp_scaled;
Fphi_scaled_ctrl = Fphi_scaled;

load('/disk1/MITgcm/verification/atm_gray_ruth/wv_off_rad_off/run_5year_p/ep_flux.mat'); %matlab_diags/ep_flux_pert.mat')
...
print('-dpng','EP_flux_diff_offoff.png')
